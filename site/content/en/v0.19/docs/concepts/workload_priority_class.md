...
A `WorkloadPriorityClass` allows you to control the [`Workload`'s](/v0.19/docs/concepts/workload) priority without affecting the pod's priority.
...
- Ordering workloads that need to borrow quota within the same [cohort](/v0.19/docs/concepts/cluster_queue/#flavors-and-borrowing-semantics).
...
- Learn how to [run jobs with workload priority](/v0.19/docs/tasks/manage/run_job_with_workload_priority)
- Learn how to [setup a default WorkloadPriorityClass](/v0.19/docs/tasks/manage/enforce_job_management/setup_default_workload_priority_class)
- Read the [API reference](/v0.19/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-WorkloadPriorityClass) for `WorkloadPriorityClass`
