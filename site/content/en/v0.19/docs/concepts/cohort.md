...
defined for [ClusterQueues](/v0.19/docs/concepts/cluster_queue/#flavors-and-resources)),
...
subject to [Borrowing and Lending limits](/v0.19/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-ResourceQuota).
