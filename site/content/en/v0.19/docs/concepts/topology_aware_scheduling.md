...
{{< include "v0.19/examples/tas/sample-queues.yaml" "yaml" >}}

An example for managing GPUs:
{{< include "v0.19/examples/tas/sample-gpu-queues.yaml" "yaml" >}}
...
through the [Provisioning AdmissionCheck](/v0.19/docs/concepts/admission_check/provisioning_request/).
...
Check also [PodSet updates in ProvisioningRequestConfig](/v0.19/docs/concepts/admission_check/provisioning_request/#podset-updates)
...
Hence, we recommend using FailFast mode described below or [WaitForPodsReady](/v0.19/docs/tasks/manage/setup_wait_for_pods_ready/)
...
[pod integration](/v0.19/docs/tasks/run/plain_pods/) — does not have this property: the
