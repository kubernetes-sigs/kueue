...
This tutorial explains how you can configure a management cluster and one worker cluster to run [JobSets](/v0.19/docs/tasks/run/jobsets/#jobset-definition) and [batch/Jobs](/v0.19/docs/tasks/run/jobs/#1-define-the-job) in a MultiKueue environment.

Check the concepts section for a [MultiKueue overview](/v0.19/docs/concepts/multikueue/). 
...
For installation of CRDs compatible with MultiKueue please refer to the dedicated pages [here](/v0.19/docs/tasks/run/multikueue/).
...
For a complete setup guide including local development with Kind, see the [Setup MultiKueue with Topology-Aware Scheduling](/v0.19/docs/tasks/dev/setup_multikueue_development_environment/) guide.
...
Refer to the [Installation guide](/v0.19/docs/installation/#change-the-feature-gates-configuration) for instructions on configuring feature gates.
