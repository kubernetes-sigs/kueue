...
{{< include "v0.19/examples/sample-validating-policy.yaml" "yaml" >}}
...
{{< include "v0.19/examples/sample-validating-policy-binding.yaml" "yaml" >}}
...
{{< include "v0.19/examples/sample-enforce-requests-policy.yaml" "yaml" >}}
...
{{< include "v0.19/examples/sample-enforce-requests-policy-binding.yaml" "yaml" >}}
