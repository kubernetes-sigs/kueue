...
[here](/v0.19/docs/installation#install-a-custom-configured-released-version) to
...
**Configure** Kueue with a 1m retention policy and enable [waitForPodsReady](/v0.19/docs/tasks/manage/setup_wait_for_pods_ready.md):
...
1. **Configure** Kueue [deployment](/v0.19/docs/installation#install-a-custom-configured-released-version) to have more resources available than the node can provide:
