...
- Your administrator has
  [set up DRA support in Kueue](/v0.19/docs/tasks/manage/setup_dra).
...
[running a regular Job](/v0.19/docs/tasks/run/jobs). You must set the
...
{{< include "v0.19/examples/dra/sample-dra-rct-job.yaml" "yaml" >}}
...
{{< include "v0.19/examples/dra/sample-dra-extended-resource-job.yaml" "yaml" >}}

### Using partitionable devices

If your administrator has configured
[counter-based quota](/v0.19/docs/tasks/manage/setup_dra/#set-up-counter-based-quota-partitionable-devices),
...
If your administrator has configured
[capacity-based quota](/v0.19/docs/tasks/manage/setup_dra/#set-up-capacity-based-quota-consumable-capacity),
...
{{< include "v0.19/examples/dra/sample-dra-capacity-job.yaml" "yaml" >}}
