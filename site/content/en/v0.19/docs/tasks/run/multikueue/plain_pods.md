...
1. Check the [MultiKueue installation guide](/v0.19/docs/tasks/manage/setup_multikueue) on how to properly setup MultiKueue clusters.

2. Follow steps in [Run Plain Pods](/v0.19/docs/tasks/run/plain_pods/#before-you-begin)
