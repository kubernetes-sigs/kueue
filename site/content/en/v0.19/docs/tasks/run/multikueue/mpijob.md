...
See [Working alongside MPI Operator](/v0.19/docs/tasks/run/multikueue/kubeflow#working-alongside-mpi-operator) for more details.
{{% /alert %}}
...
Once the setup is complete you can test it by running a MPIJob [`sample-mpijob.yaml`](/v0.19/docs/tasks/run/kubeflow/mpijobs/#sample-mpijob).
