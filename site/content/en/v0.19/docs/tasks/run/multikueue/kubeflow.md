...
For Kubeflow Trainer v2 TrainJob, see [Run TrainJobs in Multi-Cluster](/v0.19/docs/tasks/run/multikueue/trainjob/).
{{% /alert %}}
...
Once the setup is complete you can test it by running one of the Kubeflow Jobs e.g. PyTorchJob [`sample-pytorchjob.yaml`](/v0.19/docs/tasks/run/kubeflow/pytorchjobs/#sample-pytorchjob). 
