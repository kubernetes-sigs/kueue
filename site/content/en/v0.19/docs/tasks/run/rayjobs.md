...
The target [local queue](/v0.19/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the RayJob configuration.
...
1. Enable feature gate for [Elastic Workloads (Workload Slices)](/v0.19/docs/concepts/elastic_workload)
