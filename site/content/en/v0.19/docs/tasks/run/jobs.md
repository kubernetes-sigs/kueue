...
If you specify only limits, Kueue will treat the limit values as requests. See [how Kueue uses resource requests](/v0.19/docs/concepts/workload#resource-requests) for details.
...
{{< include "v0.19/examples/jobs/sample-job-partial-admission.yaml" "yaml" >}}
...
{{< include "v0.19/examples/jobs/sample-scalable-job.yaml" "yaml" >}}
