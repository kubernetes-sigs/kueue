...
This integration is based on the [Plain Pod Group](https://kueue.sigs.k8s.io/v0.19/docs/tasks/run/plain_pods/) integration.
...
The target [local queue](/v0.19/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the LeaderWorkerSet configuration.
...
- [Configure the cluster for Topology Aware Scheduling](/v0.19/docs/concepts/topology_aware_scheduling).
...
## Multikueue
Check [MultiKueue](/v0.19/docs/tasks/run/multikueue/leaderworkerset) for details on running LeaderWorkerSets in MultiKueue environment.
...
Enable the alpha
[`WorkloadIdentifierAnnotations`](/v0.19/docs/getting-started/installation/#feature-gates-for-alpha-and-beta-features)
