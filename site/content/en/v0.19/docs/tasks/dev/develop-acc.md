...
Read [Admission Check](/v0.19/docs/concepts/admission_check/) to learn more about the mechanism from a user perspective.
...
It is in charge of maintaining the [AdmissionCheckStates](/v0.19/docs/concepts/admission_check/#admissioncheckstates) of individual workloads
based on the ACC's custom logic. It can either allow the admission, requeue or fail the workload. 

The [Provisioning Admission Check Controller](/v0.19/docs/concepts/admission_check/provisioning_request/) implements this in `pkg/controller/admissionchecks/provisioning/controller.go`
