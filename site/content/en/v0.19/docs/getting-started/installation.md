...
3. In the `kueue-manager-config` ConfigMap manifest, edit the
   ...
   the default [KueueConfiguration](/v0.19/docs/reference/kueue-config.v1beta2).
...
- Read the [API reference](/v0.19/docs/reference/kueue-config.v1beta2/#Configuration) for `Configuration`
