...
Kueue publishes [metrics](/v0.19/docs/reference/metrics) to monitor its operators.
...
a third-party one, e.g. [cert-manager](https://github.com/cert-manager/cert-manager), follow the [cert manager guide](/v0.19/docs/tasks/manage/productization/cert_manager).
...
For more detailed setup instructions and optional metrics configuration, see the [Observability guide](/v0.19/docs/tasks/manage/observability/).

### Add API Priority and Fairness configuration for the visibility API

See [Configure API Priority and Fairness](/v0.19/docs/tasks/manage/monitor_pending_workloads/pending_workloads_on_demand/#configure-api-priority-and-fairness) for more details.
...
3. In the `kueue-manager-config` ConfigMap manifest, edit the
   ...
   the default [KueueConfiguration](/v0.19/docs/reference/kueue-config.v1beta1).
...
{{% alert title="Note" color="primary" %}}
See [All-or-nothing with ready Pods](/v0.19/docs/tasks/manage/setup_wait_for_pods_ready) to learn
...
- Follow the [Quick Start](/v0.19/docs/getting-started/quick-start) guide to run your first Job with Kueue.

- Read the [API reference](/v0.19/docs/reference/kueue-config.v1beta1/#Configuration) for `Configuration`
