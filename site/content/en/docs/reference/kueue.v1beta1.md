...
<a href="#kueue-x-k8s-io-v1beta1-WithinClusterQueueConfig"><code>WithinClusterQueueConfig</code></a>
</td>
<td>
...
<td>
   <p>flavorUsage are the used quotas, by flavor currently in use by the
workloads assigned to this LocalQueue.</p>
</td>
</tr>
...
## `WithinClusterQueueConfig`     {#kueue-x-k8s-io-v1beta1-WithinClusterQueueConfig}
...
before it becomes eligible for preemption.</p>
</td>
</tr>
</tbody>
</table>
