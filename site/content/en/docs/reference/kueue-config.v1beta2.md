...
## `FailureRecoveryPolicy`     {#config-kueue-x-k8s-io-v1beta2-FailureRecoveryPolicy}
...
<a href="#config-kueue-x-k8s-io-v1beta2-FailureRecoveryRule"><code>[]FailureRecoveryRule</code></a>
</td>
<td>
...
## `FailureRecoveryRule`     {#config-kueue-x-k8s-io-v1beta2-FailureRecoveryRule}
...
<a href="#config-kueue-x-k8s-io-v1beta2-TerminatePodConfig"><code>TerminatePodConfig</code></a>
</td>
<td>
...
## `TerminatePodConfig`     {#config-kueue-x-k8s-io-v1beta2-TerminatePodConfig}
