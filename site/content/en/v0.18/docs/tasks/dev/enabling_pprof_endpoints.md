...
To enable pprof endpoints, you need to set a `pprofBindAddress` is set in the [manager's configuration](/v0.18/docs/installation/#install-a-custom-configured-released-version).
