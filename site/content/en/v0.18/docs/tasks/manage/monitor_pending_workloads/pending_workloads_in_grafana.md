...
The intended audience for this page are [batch administrators](/v0.18/docs/tasks#batch-administrator)
for ClusterQueue visibility, and [batch users](/v0.18/docs/tasks#batch-user) for LocalQueue visibility.
...
- [Kueue](/v0.18/docs/installation) v0.15.0 or later is installed.
- Prometheus Operator is installed. See [Setup Prometheus](/v0.18/docs/tasks/manage/observability/setup_prometheus) for instructions.
- The [VisibilityOnDemand](/v0.18/docs/tasks/manage/monitor_pending_workloads/pending_workloads_on_demand/#monitor-pending-workloads-on-demand) feature is enabled.
...
{{< include "v0.18/examples/visibility/grafana-cluster-queue-reader.yaml" "yaml" >}}

- For `LocalQueue` visibility:

{{< include "v0.18/examples/visibility/grafana-local-queue-reader.yaml" "yaml" >}}
