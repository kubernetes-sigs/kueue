...
- [Kueue is installed](/v0.18/docs/installation) in version 0.3.0 or later.
...
Once the number of re-queues reaches the limit, Kueue [deactivates the Workload](/v0.18/docs/concepts/workload/#active).
...
prevent deadlock situations. Note that [Topology-Aware Scheduling](/v0.18/docs/concepts/topology_aware_scheduling)
