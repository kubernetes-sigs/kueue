...
This page shows how to set up Prometheus to scrape Kueue metrics. For TLS-secured metrics endpoints, see [Configure Prometheus with TLS](/v0.18/docs/tasks/manage/productization/prometheus).
...
See [Prometheus Metrics](/v0.18/docs/reference/metrics#optional-metrics) for the full list of optional metrics.
...
- See [Configure Prometheus with TLS](/v0.18/docs/tasks/manage/productization/prometheus) for advanced TLS configuration using cert-manager.
- See [Setup Dev Monitoring](/v0.18/docs/tasks/dev/setup_dev_monitoring) for a local development setup with Prometheus.
