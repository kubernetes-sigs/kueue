...
This page demonstrates how to use [resource transformations](/v0.18/docs/tasks/manage/administer_cluster_quotas/#transform-resources-for-quota-management) to enforce a unified quota that applies across multiple [resource flavors](/v0.18/docs/concepts/cluster_queue#resourceflavor-object).
...
Follow the [installation instructions for using a custom configuration](/v0.18/docs/installation#install-a-custom-configured-released-version) and extend the Kueue configuration:
...
{{< include "v0.18/examples/admin/shared-quota-setup.yaml" "yaml" >}}
...
{{< include "v0.18/examples/admin/shared-quota-sample-job.yaml" "yaml" >}}
...
- [Transform resources for quota management](/v0.18/docs/tasks/manage/administer_cluster_quotas/#transform-resources-for-quota-management)
- [Using HAMi vGPU](/v0.18/docs/tasks/run/using_hami)
