...
Kueue creates ProvisioningRequests via the [Provisioning Admission Check Controller](/v0.18/docs/concepts/admission_check/provisioning_request/), and treats them like an [Admission Check](/v0.18/docs/concepts/admission_check/). In order for Kueue to admit a Workload, the ProvisioningRequest created for it needs to succeed.
...
See the [Troubleshooting Jobs guide](/v0.18/docs/tasks/troubleshooting/troubleshooting_jobs/#identifying-the-workload-for-your-job), to learn how to identify the Workload for your job.
...
See the [Troubleshooting Queues](/v0.18/docs/tasks/troubleshooting/troubleshooting_queues/) for more details.
...
Where `ADMISSIONCHECK_NAME` is a name configured in your ClusterQueue spec. See the [Admission Check documentation](/v0.18/docs/concepts/admission_check/) for more details.
