...
The target [local queue](/v0.18/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the RayCluster configuration.
...
- In-Tree Autoscaling Constraints: Autoscaling is only supported for [elastic](/v0.18/docs/concepts/elastic_workload) RayCluster objects. To enable in-tree autoscaling:
...
{{< include "v0.18/examples/jobs/ray-cluster-sample.yaml" "yaml" >}}
