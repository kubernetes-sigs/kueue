...
[Plain Pod Group](https://kueue.sigs.k8s.io/v0.18/docs/tasks/run/plain_pods/) integration,
...
The target [local queue](/v0.18/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the StatefulSet configuration.
...
{{< include "v0.18/examples/serving-workloads/sample-statefulset.yaml" "yaml" >}}
