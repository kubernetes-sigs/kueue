...
The target [local queue](/v0.18/docs/concepts/local_queue) should be specified in the `spec.jobLabels` section of the MiniCluster configuration.
...
For equivalent instructions for doing this in Python, see [Run Python Jobs](/v0.18/docs/tasks/run/python_jobs/#flux-operator-job).
