...
If you specify only limits, Kueue will treat the limit values as requests. See [how Kueue uses resource requests](/v0.18/docs/concepts/workload#resource-requests) for details.
