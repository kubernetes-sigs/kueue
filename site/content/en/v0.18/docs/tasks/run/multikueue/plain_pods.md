...
1. Check the [MultiKueue installation guide](/v0.18/docs/tasks/manage/setup_multikueue) on how to properly setup MultiKueue clusters.

2. Follow steps in [Run Plain Pods](/v0.18/docs/tasks/run/plain_pods/#before-you-begin)
...
1. Single plain pod
{{< include "v0.18/examples/pods-kueue/kueue-pod.yaml" "yaml" >}}

2. Group of pods
{{< include "v0.18/examples/pods-kueue/kueue-pod-group.yaml" "yaml" >}}