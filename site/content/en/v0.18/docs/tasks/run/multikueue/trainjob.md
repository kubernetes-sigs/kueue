...
For legacy Kubeflow Jobs (v1), see [Run Kubeflow Jobs in Multi-Cluster](/v0.18/docs/tasks/run/multikueue/kubeflow/).
{{% /alert %}}

## MultiKueue integration

Once the setup is complete you can test it by running a TrainJob [`sample-trainjob`](/v0.18/docs/tasks/run/trainjobs/#using-clustertrainingruntime). 
