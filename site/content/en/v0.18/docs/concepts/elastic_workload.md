...
**Note:** While scaling **down** is conceptually similar to [Dynamic Reclaim](https://kueue.sigs.k8s.io/v0.18/docs/concepts/workload/#dynamic-reclaim), it is an orthogonal concept, it neither intersects with nor depends on Dynamic Reclaim functionality.
...
{{< include "v0.18/examples/jobs/sample-scalable-job.yaml" "yaml" >}}
...
See [Run A RayJob](/v0.18/docs/tasks/run/rayjobs)
