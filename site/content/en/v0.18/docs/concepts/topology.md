...
[Topology Aware Scheduling](/v0.18/docs/concepts/topology_aware_scheduling) by
providing a model for representing the hierarchy of organizational units
(such as zones, blocks, and racks) using node labels.

The `Topology` object is referenced from a [ResourceFlavor](/v0.18/docs/concepts/resource_flavor)
...
- Learn how to use [Topology Aware Scheduling](/v0.18/docs/concepts/topology_aware_scheduling)
- Read the [API reference](/v0.18/docs/reference/kueue.v1beta2/#kueue-x-k8s-io-v1beta2-Topology) for `Topology`
