...
You can disable it by editing the `AdmissionFairSharing` feature gate. Check the [Installation](/v0.18/docs/installation/#change-the-feature-gates-configuration) guide for details on feature gate configuration.
{{% /alert %}}
