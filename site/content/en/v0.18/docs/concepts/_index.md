...
### [Resource Flavor](/v0.18/docs/concepts/resource_flavor)
...
### [Admission Check](/v0.18/docs/concepts/admission_check)
...
### [Dynamic Resource Allocation](/v0.18/docs/concepts/dynamic_resource_allocation)
...
[ClusterQueues ResourceGroups](/v0.18/docs/concepts/cluster_queue#resource-groups)
...
- the physical Node capacity allows to run the Workload, when [Topology-Aware Scheduling](/v0.18/docs/concepts/topology_aware_scheduling/) is used
- all(optional) its AdmissionCheckStates are in the`Ready` state. 

### [Cohort](/v0.18/docs/concepts/cluster_queue#cohort)
...
### [Preemption](/v0.18/docs/concepts/preemption)
...
### [Fair Sharing](/v0.18/docs/concepts/fair_sharing)

Mechanisms in Kueue to share quota between tenants fairly.

### [Elastic Workloads](/v0.18/docs/concepts/elastic_workload)
