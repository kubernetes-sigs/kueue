...
A `WorkloadPriorityClass` allows you to control the [`Workload`'s](/v0.17/docs/concepts/workload) priority without affecting the pod's priority.
...
- Learn how to [run jobs](/v0.17/docs/tasks/run/jobs)
- Learn how to [run jobs with workload priority](/v0.17/docs/tasks/manage/run_job_with_workload_priority)
- Read the [API reference](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-WorkloadPriorityClass) for `WorkloadPriorityClass`
