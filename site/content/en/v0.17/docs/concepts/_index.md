...
### [Resource Flavor](/v0.17/docs/concepts/resource_flavor)
...
### [Admission Check](/v0.17/docs/concepts/admission_check)
...
[ClusterQueues ResourceGroups](/v0.17/docs/concepts/cluster_queue#resource-groups)
...
- the physical Node capacity allows to run the Workload, when [Topology-Aware Scheduling](/v0.17/docs/concepts/topology_aware_scheduling/) is used
- all(optional) its AdmissionCheckStates are in the`Ready` state. 

### [Cohort](/v0.17/docs/concepts/cluster_queue#cohort)
...
### [Preemption](/v0.17/docs/concepts/preemption)
...
### [Fair Sharing](/v0.17/docs/concepts/fair_sharing)

Mechanisms in Kueue to share quota between tenants fairly.

### [Elastic Workloads](/v0.17/docs/concepts/elastic_workload)
