...
(team or user) of the organization. A `LocalQueue` points to one [`ClusterQueue`](/v0.17/docs/concepts/cluster_queue)
...
- Launch a [Workload](/v0.17/docs/concepts/workload) through a local queue
- Read the [API reference](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-LocalQueue) for `LocalQueue`
