...
This is useful to reproduce issues on a specific released version (e.g. for on-call debugging). For installing a released version into a real cluster (not e2e), see [Install a released version](/v0.17/docs/installation/#install-a-released-version).
...
For more details, see [Setup Dev Monitoring](/v0.17/docs/tasks/dev/setup_dev_monitoring).
