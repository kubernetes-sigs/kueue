...
This tutorial explains how you can configure a manager cluster and worker clusters to run jobs with [Topology-Aware Scheduling (TAS)](/v0.17/docs/tasks/run/leaderworkerset/#configure-topology-aware-scheduling) in a MultiKueue environment. We also outline the automated steps using Kind for local testing.

Check the concepts section for a [MultiKueue overview](/v0.17/docs/concepts/multikueue/) and [Topology-Aware Scheduling overview](/v0.17/docs/concepts/topology_aware_scheduling/).
...
{{< include "v0.17/examples/multikueue/dev/sample-tas-job.yaml" "yaml" >}}
...
- Learn more about [Topology-Aware Scheduling](/v0.17/docs/concepts/topology_aware_scheduling/)
- Explore [MultiKueue concepts](/v0.17/docs/concepts/multikueue/)
