...
The page is intended for a [platform developer](/v0.17/docs/tasks#platform-developer).
...
See [Prometheus Metrics](/v0.17/docs/reference/metrics#optional-metrics) for the full list of optional metrics.
...
- See [Setup Prometheus](/v0.17/docs/tasks/manage/observability/setup_prometheus) for production setup instructions.
