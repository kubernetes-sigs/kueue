...
Kueue creates a [Workload](/v0.17/docs/concepts/workload/) object for each Job to track its admission status. 
...
If you don't have `kueuectl` installed, follow the [installation guide](/v0.17/docs/reference/kubectl-kueue/installation/).
{{% /alert %}}
