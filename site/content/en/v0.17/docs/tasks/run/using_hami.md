...
Below we demonstrate how to support this with the [resource transformation for quota management](/v0.17/docs/tasks/manage/administer_cluster_quotas/#transform-resources-for-quota-management) in Kueue.
...
2. Follow the [installation instructions for using a custom configuration](/v0.17/docs/installation#install-a-custom-configured-released-version) to configure Kueue with ResourceTransformation.
...
{{< include "v0.17/examples/serving-workloads/sample-hami.yaml" "yaml" >}}
