...
You can [modify kueue configurations from installed releases](/v0.17/docs/installation#install-a-custom-configured-released-version) to include PyTorchJobs as an allowed workload.
...
The target [local queue](/v0.17/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the PyTorchJob configuration.
...
{{< include "v0.17/examples/jobs/sample-pytorchjob.yaml" "yaml" >}}
