...
This integration is based on the [Plain Pod Group](https://kueue.sigs.k8s.io/v0.17/docs/tasks/run/plain_pods/) integration.

This guide is for [serving users](/v0.17/docs/tasks#serving-user) that have a basic understanding of Kueue.
For more information, see [Kueue's overview](/v0.17/docs/overview).
...
3. Check [Administer cluster quotas](/v0.17/docs/tasks/manage/administer_cluster_quotas) for details on the initial Kueue setup.
...
The target [local queue](/v0.17/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the LeaderWorkerSet configuration.
...
- [Configure the cluster for Topology Aware Scheduling](/v0.17/docs/concepts/topology_aware_scheduling).
...
{{< include "v0.17/examples/serving-workloads/sample-leaderworkerset-tas.yaml" "yaml" >}}
...
## Multikueue
Check [MultiKueue](/v0.17/docs/tasks/run/multikueue/leaderworkerset) for details on running LeaderWorkerSets in MultiKueue environment.
