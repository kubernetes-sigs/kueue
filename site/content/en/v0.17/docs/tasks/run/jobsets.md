...
1. Check [Administer cluster quotas](/v0.17/docs/tasks/manage/administer_cluster_quotas) for details on the initial Kueue setup.
...
The target [local queue](/v0.17/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the JobSet configuration.
...
{{< include "v0.17/examples/jobs/sample-jobset.yaml" "yaml" >}}
