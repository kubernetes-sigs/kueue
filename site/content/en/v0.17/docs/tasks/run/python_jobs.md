...
This guide is for [batch users](/v0.17/docs/tasks#batch-user) that have a basic understanding of interacting with Kubernetes from Python. For more information, see [Kueue's overview](/v0.17/docs/overview).
...
Finally, for instructions for how to do this with YAML outside of Python, see [Run A Flux MiniCluster](/v0.17/docs/tasks/run/external_workloads/flux_miniclusters/).
...
If you are interested in running this same example with YAML outside of Python, see [Run an MPIJob](/v0.17/docs/tasks/run/kubeflow/mpijobs/).
