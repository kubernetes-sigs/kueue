...
The target [local queue](/v0.17/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the RayCluster configuration.
...
- In-Tree Autoscaling Constraints: Autoscaling is only supported for [elastic](/v0.17/docs/concepts/elastic_workload) RayCluster objects. To enable in-tree autoscaling:
