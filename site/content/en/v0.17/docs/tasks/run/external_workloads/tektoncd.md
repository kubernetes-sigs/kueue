...
We demonstrate how to support scheduling Tekton Pipelines Tasks in Kueue based on the [Plain Pod](/v0.17/docs/tasks/run/plain_pods) integration, where every Pod from a Pipeline is represented as a single independent Plain Pod.
...
1. Check [Administrator cluster quotas](/v0.17/docs/tasks/manage/administer_cluster_quotas/) for details on the initial Kueue step.
...
If you want every task to target a single [local queue](/v0.17/docs/concepts/local_queue),
