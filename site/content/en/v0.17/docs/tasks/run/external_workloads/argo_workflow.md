...
but you can take advantage of the ability for Kueue to [manage plain pods](/v0.17/docs/tasks/run/plain_pods) to integrate them.

## Before you begin

1. Learn how to [install Kueue with a custom manager configuration](/v0.17/docs/installation/#install-a-custom-configured-released-version).

2. Follow steps in [Run Plain Pods](/v0.17/docs/tasks/run/plain_pods/#before-you-begin)
...
If you want the entire workflow to target a single [local queue](/v0.17/docs/concepts/local_queue),
it should be specified in the `spec.podMetadata` section of the Workflow configuration.

{{< include "v0.17/examples/pod-based-workloads/workflow-single-queue.yaml" "yaml" >}}

### b. Targeting a different LocalQueue per template

If you prefer to target a different [local queue](/v0.17/docs/concepts/local_queue) for each step of your Workflow,
...
{{< include "v0.17/examples/pod-based-workloads/workflow-queue-per-template.yaml" "yaml" >}}
