...
Check the [MultiKueue installation guide](/v0.17/docs/tasks/manage/setup_multikueue) on how to properly setup MultiKueue clusters.
...
See [Working alongside MPI Operator](/v0.17/docs/tasks/run/multikueue/kubeflow#working-alongside-mpi-operator) for more details.
{{% /alert %}}
...
Once the setup is complete you can test it by running a MPIJob [`sample-mpijob.yaml`](/v0.17/docs/tasks/run/kubeflow/mpijobs/#sample-mpijob).
