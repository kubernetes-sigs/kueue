...
See [Run Plain Pods](/v0.17/docs/tasks/run/plain_pods/#before-you-begin) for configuration details.
{{% /alert %}}
...
{{< include "v0.17/examples/serving-workloads/sample-statefulset.yaml" "yaml" >}}
