...
Once the setup is complete you can test it by running an AppWrapper [`appwrapper-pytorch-sample.yaml`](/v0.17/docs/tasks/run/appwrappers/#example-appwrapper-containing-a-pytorchjob).
