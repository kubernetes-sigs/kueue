...
Check [Administer cluster quotas](/v0.17/docs/tasks/manage/administer_cluster_quotas) for details on the initial Kueue setup.
...
The target [local queue](/v0.17/docs/concepts/local_queue) should be specified in the `metadata.labels` section of the AppWrapper.
...
{{< include "v0.17/examples/appwrapper/pytorch-sample.yaml" "yaml" >}}
...
{{< include "v0.17/examples/appwrapper/deployment-sample.yaml" "yaml" >}}
