...
The page is intended for a [batch administrator](/v0.17/docs/tasks#batch-administrator).
...
- View the status of their [Workloads](/v0.17/docs/concepts/workload) in their namespace.
