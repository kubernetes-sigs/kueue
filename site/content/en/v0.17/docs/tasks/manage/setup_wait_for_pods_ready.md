...
- [Kueue is installed](/v0.17/docs/installation) in version 0.3.0 or later.

## Enabling waitForPodsReady

Follow the instructions described
[here](/v0.17/docs/installation#install-a-custom-configured-released-version) to
...
Once the number of re-queues reaches the limit, Kueue [deactivates the Workload](/v0.17/docs/concepts/workload/#active).
...
prevent deadlock situations. Note that [Topology-Aware Scheduling](/v0.17/docs/concepts/topology_aware_scheduling)
