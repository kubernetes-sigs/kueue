...
This tutorial explains how you can configure a management cluster and one worker cluster to run [JobSets](/v0.17/docs/tasks/run/jobsets/#jobset-definition) and [batch/Jobs](/v0.17/docs/tasks/run/jobs/#1-define-the-job) in a MultiKueue environment.

Check the concepts section for a [MultiKueue overview](/v0.17/docs/concepts/multikueue/). 
...
{{< include "v0.17/examples/admin/single-clusterqueue-setup.yaml" "yaml" >}}
...
{{< include "v0.17/examples/multikueue/create-multikueue-kubeconfig.sh" "bash" >}}
...
For installation of CRDs compatible with MultiKueue please refer to the dedicated pages [here](/v0.17/docs/tasks/run/multikueue/).
...
{{< include "v0.17/examples/multikueue/multikueue-setup.yaml" "yaml" >}}
...
{{< include "v0.17/examples/multikueue/tas/worker-setup.yaml" "yaml" >}}

Manager cluster configuration:

{{< include "v0.17/examples/multikueue/tas/manager-setup.yaml" "yaml" >}}

For a complete setup guide including local development with Kind, see the [Setup MultiKueue with Topology-Aware Scheduling](/v0.17/docs/tasks/dev/setup_multikueue_development_environment/) guide.
...
Refer to the [Installation guide](/v0.17/docs/installation/#change-the-feature-gates-configuration) for instructions on configuring feature gates.
