...
定义后，可以在 [ClusterQueue 的 spec](/v0.17/docs/concepts/cluster_queue) 中引用 AdmissionCheck。所有与该队列关联的 Workload 都需要由 AdmissionCheck 的控制器评估后才能被准入。
...
- 阅读 `AdmissionCheck` 的 [API 参考](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-AdmissionCheck)
- 了解更多内置的 [Provisioning Admission Check Controller](/v0.17/docs/admission-check-controllers/provisioning)
