...
一旦定义，AdmissionCheck 可以在[ClusterQueue 的规约](/v0.17/docs/concepts/cluster_queue)中引用。
...
- Workload 被停用 - [`workload.Spec.Active`](/v0.17/docs/concepts/workload/#active) 设置为 `False`
...
- 阅读 [API 参考](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-AdmissionCheck)了解 `AdmissionCheck`
- 从内置的[准入检查控制器](/v0.17/docs/concepts/admission_check/provisioning_request)学习更多
