...
`WorkloadPriorityClass` 允许你控制 [`Workload`](/v0.17/docs/concepts/workload) 的优先级，而不会影响 Pod 的优先级。
此功能适用于以下场景：
...
- 了解如何[使用 Workload 优先级运行作业](/v0.17/docs/tasks/manage/run_job_with_workload_priority)
- 阅读 `WorkloadPriorityClass` 的 [API 参考](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-WorkloadPriorityClass)
