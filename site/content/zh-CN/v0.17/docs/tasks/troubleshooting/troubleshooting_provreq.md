...
Kueue 通过 [Provisioning Admission Check Controller](/v0.17/docs/admission-check-controllers/provisioning/)
创建 ProvisioningRequest，并将其视为[准入检查](/v0.17/docs/concepts/admission_check/)。
...
- 你已在[特性门控配置](/v0.17/docs/installation/#change-the-feature-gates-configuration)中启用了 `ProvisioningACC`。
  对于 Kueue `v0.7.0` 或更新版本，此特性门控默认启用。

## 识别你的作业对应的 Provisioning Request {#identifying-the-provisioning-request-for-your-job}

请参阅 [Job 故障排除指南](/v0.17/docs/tasks/troubleshooting/troubleshooting_jobs/#identifying-the-workload-for-your-job)，
...
有关更多详细信息，请参阅[队列故障排除](/v0.17/docs/tasks/troubleshooting/troubleshooting_queues/)。
...
有关更多详细信息，请参阅[准入检查文档](/v0.17/docs/concepts/admission_check/)。
