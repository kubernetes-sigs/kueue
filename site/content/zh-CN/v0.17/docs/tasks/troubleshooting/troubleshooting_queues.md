...
[LocalQueue](/v0.17/docs/concepts/local_queue) 的状态包含 LocalQueue 上任何配置问题的详细信息，
作为 `Active` 条件的一部分。
...
[ClusterQueue](/v0.17/docs/concepts/cluster_queue) 的状态包含 ClusterQueue 上任何配置问题的详细信息，
作为 `Active` 条件的一部分。
...
阅读[管理 ClusterQueue](/v0.17/docs/tasks/manage/administer_cluster_quotas)了解如何配置 ClusterQueue。
...
阅读 [Job 故障排除](/v0.17/docs/tasks/troubleshooting/troubleshooting_jobs)了解为什么单个作业无法被准入。
