...
{{< include file="v0.17/examples/python/install-kueue-queues.py" lang="python" >}}
...
```bash
python install-kueue-queues.py --version v0.17.7
```
...
{{< include file="v0.17/examples/python/sample-job.py" code="true" lang="python" >}}
...
{{< include file="v0.17/examples/python/sample-queue-control.py" lang="python" >}}
...
{{< include file="v0.17/examples/python/sample-flux-operator-job.py" lang="python" >}}
...
{{< include "v0.17/examples/python/sample-mpijob.py" "python" >}}
