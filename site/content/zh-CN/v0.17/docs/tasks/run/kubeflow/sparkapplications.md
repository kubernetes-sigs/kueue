...
有关特性门控配置的详细信息，
请参阅[安装](/v0.17/docs/installation/#change-the-feature-gates-configuration)指南。
{{% /alert %}}
...
欲了解更多信息，请参阅 [Kueue 概述](/v0.17/docs/overview)。

## 在你开始之前

检查[管理集群配额](/v0.17/docs/tasks/manage/administer_cluster_quotas)，
以获取初始集群设置的详细信息。

查阅 [Spark Operator 安装指南](https://www.kubeflow.org/docs/components/spark-operator/getting-started/#installation)。

你可以[修改已安装版本的 Kueue 配置](/v0.17/docs/installation#install-a-custom-configured-released-version)，
...
目标[本地队列](/v0.17/docs/concepts/local_queue)应在 SparkApplication
