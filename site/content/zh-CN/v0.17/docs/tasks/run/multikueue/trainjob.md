...
查阅 [MultiKueue 安装指南](/v0.17/docs/tasks/manage/setup_multikueue)以了解如何正确设置 MultiKueue 集群。
...
对于遗留的 Kubeflow Jobs（v1），请参阅[在多集群中运行 Kubeflow Job](/v0.17/docs/tasks/run/multikueue/kubeflow/)。
{{% /alert %}}

## MultiKueue 集成

完成设置后，你可以通过运行一个 TrainJob
[`sample-trainjob`](/v0.17/docs/tasks/run/trainjobs/#using-clustertrainingruntime) 来测试它。
