...
[Alpha/Beta](/v0.17/docs/installation/#feature-gates-for-alpha-and-beta-features)
特性门控表或
[Graduated/Deprecated](/v0.17/docs/installation/#feature-gates-for-graduated-or-deprecated-features)
特性门控表。
