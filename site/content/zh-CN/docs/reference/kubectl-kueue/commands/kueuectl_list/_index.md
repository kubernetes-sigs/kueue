...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tr>
        <td></td>
        <td style="line-height: 130%; word-wrap: break-word;">
            <p>用于 API 服务器身份验证的 Bearer token</p>
        </td>
    </tr>
    <tr>
...
* [kueuectl list clusterqueue](kueuectl_list_clusterqueue/) - 列出 ClusterQueue
* [kueuectl list localqueue](kueuectl_list_localqueue/) - 列出 LocalQueue
* [kueuectl list pods](kueuectl_list_pods/) - 列出属于作业类型的 Pod
* [kueuectl list resourceflavor](kueuectl_list_resourceflavor/) - 列出 ResourceFlavor
* [kueuectl list workload](kueuectl_list_workload/) - 列出 Workload
