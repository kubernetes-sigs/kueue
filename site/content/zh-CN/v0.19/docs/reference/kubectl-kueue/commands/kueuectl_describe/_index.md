...
* [kueuectl describe clusterqueue](kueuectl_describe_clusterqueue/) - 传递 `describe clusterqueue` 给 kubectl
* [kueuectl describe localqueue](kueuectl_describe_localqueue/) - 传递 `describe localqueue` 给 kubectl
* [kueuectl describe resourceflavor](kueuectl_describe_resourceflavor/) - 传递 `describe resourceflavor` 给 kubectl
* [kueuectl describe workload](kueuectl_describe_workload/) - 传递 `describe workload` 给 kubectl
