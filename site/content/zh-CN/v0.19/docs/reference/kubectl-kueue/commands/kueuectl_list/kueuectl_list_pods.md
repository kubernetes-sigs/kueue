...
列出所有符合给定条件的 Pod：属于指定的 Job 类型、隶属于指定的命名空间、匹配标签选择器或字段选择器。

- `--for=pod/pod-name` 选项允许查找与指定 Pod 属于同一 Pod 组的 Pod，包括该 Pod 本身。
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tr>
        ...
        <td style="line-height: 130%; word-wrap: break-word;">
             <p>如果存在，跨所有命名空间列出请求的对象。即使使用 --namespace 指定了当前上下文中的命名空间，也会被忽略。</p>
        </td>
    </tr>
    <tr>
