...
(https://kueue.sigs.k8s.io/v0.19/docs/tasks/manage/monitor_pending_workloads/pending_workloads_on_demand/)
代替。</p>
</td>
</tr>
...
(https://kueue.sigs.k8s.io/v0.19/docs/tasks/run/plain_pods/)
代替。</p>
</td>
</tr>
