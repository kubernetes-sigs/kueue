...
本页面的目标受众是[批处理管理员](/v0.19/docs/tasks#batch-administrator)。
...
- Prometheus 已[设置](/v0.19/docs/tasks/manage/observability/setup_prometheus)以抓取 Kueue 指标。

## 配置自定义标签

自定义指标标签需要 `CustomMetricLabels` 特性门控，它是 Alpha 级别且默认禁用。
关于如何启用特性门控的详情，请参见[安装](/v0.19/docs/installation/#change-the-feature-gates-configuration)。
