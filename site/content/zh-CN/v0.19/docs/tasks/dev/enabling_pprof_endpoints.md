...
本页面的目标读者是[批处理管理员](/zh-cn/v0.19/docs/tasks#batch-administrator)。
...
要开启 pprof 端点，
你需要在[管理器的配置](/v0.19/docs/installation/#install-a-custom-configured-released-version)中设置 `pprofBindAddress`。
