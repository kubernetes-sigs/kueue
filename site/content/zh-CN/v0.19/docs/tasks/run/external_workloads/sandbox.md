...
Kueue 通过 [Plain Pod](/zh-cn/v0.19/docs/tasks/run/plain_pods) 集成来管理 Sandbox 控制器创建的 Pod，
...
3. 查看[管理员集群配额](/zh-cn/v0.19/docs/tasks/manage/administer_cluster_quotas/)以获取初始 Kueue 设置的详细信息。
...
目标[本地队列](/zh-cn/v0.19/docs/concepts/local_queue)应在 Sandbox 配置的
...
{{< include "v0.19/examples/pod-based-workloads/sample-sandbox.yaml" "yaml" >}}
