...
请查阅 [MultiKueue 安装指南](/zh-cn/v0.19/docs/tasks/manage/setup_multikueue)了解如何正确设置 MultiKueue 集群。
...
完成设置后，你可以通过运行 AppWrapper [`appwrapper-pytorch-sample.yaml`](/zh-cn/v0.19/docs/tasks/run/appwrappers/#example-appwrapper-containing-a-pytorchjob)进行测试。
