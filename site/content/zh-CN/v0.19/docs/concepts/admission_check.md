...
定义后，可以在 [ClusterQueue 的 spec](/v0.19/docs/concepts/cluster_queue) 中引用 AdmissionCheck。所有与该队列关联的 Workload 都需要由 AdmissionCheck 的控制器评估后才能被准入。
...
- 了解更多内置的 [Provisioning Admission Check Controller](/zh-CN/v0.19/docs/admission-check-controllers/provisioning)
