...
`WorkloadPriorityClass` 允许你控制 [`Workload`](/v0.19/docs/concepts/workload) 的优先级，而不会影响 Pod 的优先级。
此功能适用于以下场景：
...
- 了解如何[使用 Workload 优先级运行作业](/v0.19/docs/tasks/manage/run_job_with_workload_priority)
- 阅读 `WorkloadPriorityClass` 的 [API 参考](/zh-cn/v0.19/docs/reference/kueue.v1beta2/#kueue-x-k8s-io-v1beta2-WorkloadPriorityClass)
