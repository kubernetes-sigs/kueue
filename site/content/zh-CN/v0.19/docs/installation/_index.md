...
Kueue 发布[指标](/zh-cn/v0.19/docs/reference/metrics)以监控其控制器组件。
...
[cert-manager](https://github.com/cert-manager/cert-manager)，请遵循[证书管理指南](/v0.19/docs/tasks/manage/productization/cert_manager)。
...
有关更多详细信息，请参阅[配置 API 优先级和公平性](/v0.19/docs/tasks/manage/monitor_pending_workloads/pending_workloads_on_demand/#configure-api-priority-and-fairness)。
...
3. 在 `kueue-manager-config` ConfigMap 清单中，编辑
   ...
   [KueueConfiguration](/zh-cn/v0.19/docs/reference/kueue-config.v1beta2)。
...
{{% alert title="Note" color="primary" %}}
请参阅 [All-or-nothing 与就绪 Pod](/v0.19/docs/tasks/manage/setup_wait_for_pods_ready) 以了解
...
- 阅读 [`Configuration` 的 API 参考](/zh-cn/v0.19/docs/reference/kueue-config.v1beta2/#Configuration)
