...
3. 在 `kueue-manager-config` ConfigMap 清单中，编辑
   ...
   [KueueConfiguration](/zh-cn/v0.19/docs/reference/kueue-config.v1beta1)。
...
- 阅读 [`Configuration` 的 API 参考](/zh-cn/v0.19/docs/reference/kueue-config.v1beta1/#Configuration)
