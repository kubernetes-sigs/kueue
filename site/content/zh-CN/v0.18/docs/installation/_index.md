...
[cert-manager](https://github.com/cert-manager/cert-manager)，请遵循[证书管理指南](/v0.18/docs/tasks/manage/productization/cert_manager)。
...
有关更多详细信息，请参阅[配置 API 优先级和公平性](/v0.18/docs/tasks/manage/monitor_pending_workloads/pending_workloads_on_demand/#configure-api-priority-and-fairness)。
...
{{% alert title="Note" color="primary" %}}
请参阅 [All-or-nothing 与就绪 Pod](/v0.18/docs/tasks/manage/setup_wait_for_pods_ready) 以了解
...
- 阅读 [`Configuration` 的 API 参考](/zh-cn/v0.18/docs/reference/kueue-config.v1beta2/#config-kueue-x-k8s-io-v1beta2-Configuration)
