...
2. 对于 Kueue v0.15 及更早版本，
   了解如何[使用自定义管理器配置安装 Kueue](/v0.18/docs/installation/#install-a-custom-configured-released-version)，
   ...
   有关配置详情，请参阅[运行普通 Pod](/v0.18/docs/tasks/run/plain_pods/#before-you-begin)。
   {{% /alert %}}
...
{{< include "v0.18/examples/serving-workloads/sample-deployment.yaml" "yaml" >}}
