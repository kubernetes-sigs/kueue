...
对于遗留的 Kubeflow Jobs（v1），请参阅[在多集群中运行 Kubeflow Job](/v0.18/docs/tasks/run/multikueue/kubeflow/)。
{{% /alert %}}

## MultiKueue 集成

完成设置后，你可以通过运行一个 TrainJob
[`sample-trainjob`](/v0.18/docs/tasks/run/trainjobs/#using-clustertrainingruntime) 来测试它。
