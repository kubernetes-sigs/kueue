...
{{< include "v0.18/examples/pod-based-workloads/tekton-sleep-task.yaml" "yaml" >}}

{{< include "v0.18/examples/pod-based-workloads/tekton-hello-task.yaml" "yaml" >}}

一个 Pipeline 由这些 Task 组成。

{{< include "v0.18/examples/pod-based-workloads/tekton-pipeline.yaml" "yaml" >}}
...
{{< include "v0.18/examples/pod-based-workloads/tekton-pipeline-run.yaml" "yaml" >}}
