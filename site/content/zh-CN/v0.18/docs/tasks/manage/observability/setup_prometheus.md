...
对于使用 TLS 保护的指标端点，请参阅[使用 TLS 配置 Prometheus](/v0.18/docs/tasks/manage/productization/prometheus)。
...
- 参阅[常用 Grafana 查询](/v0.18/docs/tasks/manage/observability/common_grafana_queries)
  获取用于在 Grafana 中监控 Kueue 的 PromQL 查询。
- 参阅[使用 TLS 配置 Prometheus](/v0.18/docs/tasks/manage/productization/prometheus)
  获取使用 cert-manager 进行高级 TLS 配置的信息。
- 参阅[设置开发监控](/v0.18/docs/tasks/dev/setup_dev_monitoring)获取带有
