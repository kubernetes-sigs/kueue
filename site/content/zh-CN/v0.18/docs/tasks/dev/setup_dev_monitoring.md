...
The page is intended for a [platform developer](/v0.18/docs/tasks#platform-developer).
...
See [Prometheus Metrics](/zh-cn/v0.18/docs/reference/metrics#optional-metrics) for the full list of optional metrics.
...
- See [Setup Prometheus](/v0.18/docs/tasks/manage/observability/setup_prometheus) for production setup instructions.
