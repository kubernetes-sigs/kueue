...
Kueue 为每个 Job 创建一个 [Workload](/v0.18/docs/concepts/workload/) 对象来跟踪其准入状态。
...
如果你没有安装 `kueuectl`，请按照[安装指南](/zh-cn/v0.18/docs/reference/kubectl-kueue/installation/)进行操作。
{{% /alert %}}
