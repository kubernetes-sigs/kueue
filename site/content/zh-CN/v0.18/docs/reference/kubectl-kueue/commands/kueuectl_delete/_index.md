...
* [kueuectl delete clusterqueue](kueuectl_delete_clusterqueue/) - 将"delete clusterqueue"透传给 kubectl
* [kueuectl delete localqueue](kueuectl_delete_localqueue/) - 将"delete localqueue"透传给 kubectl
* [kueuectl delete resourceflavor](kueuectl_delete_resourceflavor/) - 将"delete resourceflavor"透传给 kubectl
* [kueuectl delete workload](kueuectl_delete_workload/) - 删除给定的 Workload 及其对应的 Job
