...
您可以通过设置 [Active](/v0.18/docs/reference/kueue.v1beta1#kueue-x-k8s-io-v1beta1-WorkloadSpec)
...
- 阅读 `Workload` 的 [API 参考](/v0.18/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-Workload)
