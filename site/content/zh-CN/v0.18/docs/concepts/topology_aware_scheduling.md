...
TAS 通过 [Provisioning AdmissionCheck](/v0.18/docs/admission-check-controllers/provisioning/)
...
另请参阅 [ProvisioningRequestConfig 中的 PodSet 更新](/v0.18/docs/admission-check-controllers/provisioning/#podset-updates)，了解如何配置 Kueue 以限制调度到新扩容节点（前提是扩容类支持）。
...
[WaitForPodsReady](/v0.18/docs/tasks/manage/setup_wait_for_pods_ready/) 并配置 `waitForPodsReady.recoveryTimeout`，
以防止工作负载无限等待替换节点。
...
请参阅[安装指南](/v0.18/docs/installation/#change-the-feature-gates-configuration)。
{{% /alert %}}
