...
启用了[拓扑感知调度](/v0.18/docs/concepts/topology_aware_scheduling)。

`Topology` 对象通过 [ResourceFlavor](/v0.18/docs/concepts/resource_flavor)
...
- 学习如何使用 [拓扑感知调度](/v0.18/docs/concepts/topology_aware_scheduling)
- 阅读 `Topology` 的 [API 参考](/zh-cn/v0.18/docs/reference/kueue.v1beta2/#kueue-x-k8s-io-v1beta2-Topology)
