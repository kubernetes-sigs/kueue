...
Before running Terraform commands, you need to set the `project_id` variable. You can either:

**Option 1: Use terraform.tfvars file (Recommended)**
```bash
...
To control DWS behavior, set the `enable_dws` variable in your `terraform.tfvars` file:
