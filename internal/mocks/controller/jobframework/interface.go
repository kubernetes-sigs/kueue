...
// Source: sigs.k8s.io/kueue/pkg/controller/jobframework (interfaces: GenericJob,JobWithCustomValidation,JobWithManagedBy,JobWithCustomWorkloadActivation,JobWithCustomAnnotations,MultiKueueAdapter,ElasticWorkloadNameProvider)
//
// Generated by this command:
//
//	mockgen -destination=internal/mocks/controller/jobframework/interface.go -copyright_file hack/boilerplate.txt -package mocks sigs.k8s.io/kueue/pkg/controller/jobframework GenericJob,JobWithCustomValidation,JobWithManagedBy,JobWithCustomWorkloadActivation,JobWithCustomAnnotations,MultiKueueAdapter,ElasticWorkloadNameProvider
//
...
func (m *MockGenericJob) PodsReady(ctx context.Context, c client.Client) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PodsReady", ctx, c)
	ret0, _ := ret[0].(bool)
	return ret0
}

// PodsReady indicates an expected call of PodsReady.
func (mr *MockGenericJobMockRecorder) PodsReady(ctx, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGenericJob) RunWithPodSetsInfo(ctx context.Context, c client.Client, podSetsInfo []podset.PodSetInfo) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RunWithPodSetsInfo", ctx, c, podSetsInfo)
	ret0, _ := ret[0].(error)
	return ret0
}

// RunWithPodSetsInfo indicates an expected call of RunWithPodSetsInfo.
func (mr *MockGenericJobMockRecorder) RunWithPodSetsInfo(ctx, c, podSetsInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunWithPodSetsInfo", reflect.TypeOf((*MockGenericJob)(nil).RunWithPodSetsInfo), ctx, c, podSetsInfo)
}
...
func (m *MockMultiKueueAdapter) DeleteRemoteObject(ctx context.Context, localClient, remoteClient client.Client, key types.NamespacedName) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteRemoteObject", ctx, localClient, remoteClient, key)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteRemoteObject indicates an expected call of DeleteRemoteObject.
func (mr *MockMultiKueueAdapterMockRecorder) DeleteRemoteObject(ctx, localClient, remoteClient, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMultiKueueAdapter) SyncJob(ctx context.Context, localClient, remoteClient client.Client, key types.NamespacedName, workloadName, origin string) (bool, error) {
	m.ctrl.T.Helper()
...
// MockElasticWorkloadNameProvider is a mock of ElasticWorkloadNameProvider interface.
type MockElasticWorkloadNameProvider struct {
	ctrl     *gomock.Controller
	recorder *MockElasticWorkloadNameProviderMockRecorder
	isgomock struct{}
}

// MockElasticWorkloadNameProviderMockRecorder is the mock recorder for MockElasticWorkloadNameProvider.
type MockElasticWorkloadNameProviderMockRecorder struct {
	mock *MockElasticWorkloadNameProvider
}

// NewMockElasticWorkloadNameProvider creates a new mock instance.
func NewMockElasticWorkloadNameProvider(ctrl *gomock.Controller) *MockElasticWorkloadNameProvider {
	mock := &MockElasticWorkloadNameProvider{ctrl: ctrl}
	mock.recorder = &MockElasticWorkloadNameProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockElasticWorkloadNameProvider) EXPECT() *MockElasticWorkloadNameProviderMockRecorder {
	return m.recorder
}

// GetWorkloadNameExtraPart mocks base method.
func (m *MockElasticWorkloadNameProvider) GetWorkloadNameExtraPart() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkloadNameExtraPart")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetWorkloadNameExtraPart indicates an expected call of GetWorkloadNameExtraPart.
func (mr *MockElasticWorkloadNameProviderMockRecorder) GetWorkloadNameExtraPart() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkloadNameExtraPart", reflect.TypeOf((*MockElasticWorkloadNameProvider)(nil).GetWorkloadNameExtraPart))
}
