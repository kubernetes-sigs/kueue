...
verify-ci-lint: verify-tree-prereqs gomod-verify ci-lint ## CI-style golangci-lint (includes generation + go.mod checks)

.PHONY: verify-lint-api
verify-lint-api: verify-tree-prereqs gomod-verify lint-api ## CI-style API lint (includes generation + go.mod checks)

.PHONY: verify-fmt-verify
verify-fmt-verify: verify-tree-prereqs fmt-verify ## Verify formatting after generation

.PHONY: verify-shell-lint
verify-shell-lint: verify-tree-prereqs shell-lint ## Shell lint after generation

.PHONY: verify-toc-verify
verify-toc-verify: verify-tree-prereqs toc-verify ## TOC verification after generation

.PHONY: verify-helm-verify
verify-helm-verify: verify-tree-prereqs helm-verify ## Helm verification after generation

.PHONY: verify-helm-unit-test
verify-helm-unit-test: verify-tree-prereqs helm-unit-test ## Helm unit tests after generation

.PHONY: verify-npm-depcheck
verify-npm-depcheck: verify-tree-prereqs prepare-release-branch npm-depcheck ## Depcheck after generation
