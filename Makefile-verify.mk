...
verify-checks: verify-ci-lint verify-lint-api verify-fmt-verify verify-e2e-common-test verify-milestone-pull-test verify-shell-lint verify-helm-verify verify-helm-unit-test verify-npm-depcheck verify-kustomize-build verify-skills-lint
