...
.PHONY: perf-threshold-help
perf-threshold-help: ## Show help for performance threshold automation
	@echo ""
	@echo "Performance Threshold Automation"
	@echo "=================================="
	@echo ""
	@echo "This suite of commands automates performance threshold calculation"
	@echo "based on historical test runs, solving issue #12841"
	@echo ""
	@echo "Basic Workflow:"
	@echo "  1. collect-performance-runs      - Run tests multiple times"
	@echo "  2. update-performance-thresholds-dry-run - Preview changes"
	@echo "  3. update-performance-thresholds - Apply new thresholds"
	@echo ""
	@echo "Commands:"
	@echo "  validate-performance-metrics     - Check metrics exist"
	@echo "  update-performance-thresholds    - Update baseline thresholds"
	@echo "  update-performance-thresholds-dry-run - Preview changes"
	@echo "  update-tas-thresholds            - Update TAS thresholds"
	@echo "  update-tas-thresholds-dry-run    - Preview TAS changes"
	@echo ""
	@echo "Advanced:"
	@echo "  make update-performance-thresholds CMD_MARGIN=0.25"
	@echo ""
	@echo "For more info, see:"
	@echo "  ./hack/performance-threshold-automation/README.md"
	@echo ""

# Add to help target if exists, or display on all
.PHONY: help-perf
help-perf: perf-threshold-help
