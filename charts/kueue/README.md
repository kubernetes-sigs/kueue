...
![Version: 0.999.0](https://img.shields.io/badge/Version-0.999.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.999.0](https://img.shields.io/badge/AppVersion-v0.999.0-informational?style=flat-square)
...
```bash
helm install kueue oci://registry.k8s.io/kueue/charts/kueue --version="0.999.0" --create-namespace --namespace=kueue-system
```
...
```bash
helm install kueue oci://registry.k8s.io/kueue/charts/kueue --version="0.999.0" \
