...
![Version: 0.19.6](https://img.shields.io/badge/Version-0.19.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.19.6](https://img.shields.io/badge/AppVersion-v0.19.6-informational?style=flat-square)
...
```bash
helm install kueue oci://registry.k8s.io/kueue/charts/kueue --version="0.19.6" --create-namespace --namespace=kueue-system
```
...
| networkPolicy.extraIngress | list | `[]` | Additional ingress rules appended to the ControllerManager's NetworkPolicy. Use this to restrict the built-in port-scoped rules to specific peers, or to permit extra traffic. |
