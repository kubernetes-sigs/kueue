...
![Version: 0.14.1](https://img.shields.io/badge/Version-0.14.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.14.1](https://img.shields.io/badge/AppVersion-v0.14.1-informational?style=flat-square)
...
```bash
helm install kueue oci://registry.k8s.io/kueue/charts/kueue --version="0.14.1" \
...
| kueueViz.backend.image.tag | string | `"release-0.14"` | KueueViz dashboard backend image tag |
...
| kueueViz.frontend.image.tag | string | `"release-0.14"` | KueueViz dashboard frontend image tag |
