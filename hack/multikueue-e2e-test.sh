...
EOF
        ...
        kubectl config --kubeconfig="$WORKER1_KUBECONFIG" set-context "kind-$WORKER1_KIND_CLUSTER_NAME" \
        --cluster="$WORKER1_KIND_CLUSTER_NAME" \
        --user="$WORKER1_KIND_CLUSTER_NAME"

        kubectl config --kubeconfig="$WORKER2_KUBECONFIG" set-context "kind-$WORKER2_KIND_CLUSTER_NAME" \
        --cluster="$WORKER2_KIND_CLUSTER_NAME" \
        --user="$WORKER2_KIND_CLUSTER_NAME"
