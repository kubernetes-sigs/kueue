...
KUBERNETES_TEST_INFRA_MAIN_REPO_ORG=${KUBERNETES_TEST_INFRA_MAIN_REPO_ORG:-$(get_repo_org "$(git remote get-url "$KUBERNETES_TEST_INFRA_UPSTREAM_REMOTE")")}
KUBERNETES_TEST_INFRA_MAIN_REPO_NAME=${KUBERNETES_TEST_INFRA_MAIN_REPO_NAME:-$(get_repo_name "$(git remote get-url "$KUBERNETES_TEST_INFRA_UPSTREAM_REMOTE")")}
