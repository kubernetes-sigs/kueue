...
.PHONY: kueue-priority-booster-test
kueue-priority-booster-test: ## Run unit tests for kueue-priority-booster.
	$(MAKE) -C cmd/experimental/kueue-priority-booster test
