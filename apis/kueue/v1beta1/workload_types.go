...
// +kubebuilder:validation:XValidation:rule="!('kueue.x-k8s.io/workload-uid' in self.metadata.labels)", message="setting 'kueue.x-k8s.io/workload-uid' is not allowed"
