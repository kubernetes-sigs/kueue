...
func (in *SchedulingStats) DeepCopyInto(out *SchedulingStats) {
	*out = *in
	if in.Evictions != nil {
		...
		*out = make([]WorkloadSchedulingStatsEvicition, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadSchedulingStatsEvicition) DeepCopyInto(out *WorkloadSchedulingStatsEvicition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadSchedulingStatsEvicition.
func (in *WorkloadSchedulingStatsEvicition) DeepCopy() *WorkloadSchedulingStatsEvicition {
	if in == nil {
		return nil
	}
	out := new(WorkloadSchedulingStatsEvicition)
	in.DeepCopyInto(out)
	return out
}
