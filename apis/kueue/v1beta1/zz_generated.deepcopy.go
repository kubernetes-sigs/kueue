...
func (in *ProvisioningRequestConfigSpec) DeepCopyInto(out *ProvisioningRequestConfigSpec) {
	*out = *in
	...
	if in.PodSetUpdates != nil {
		in, out := &in.PodSetUpdates, &out.PodSetUpdates
		*out = make([]ProvisioningRequestPodSetUpdate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProvisioningRequestPodSetUpdate) DeepCopyInto(out *ProvisioningRequestPodSetUpdate) {
	*out = *in
	if in.Key != nil {
	...
	if in.ValueFromDetail != nil {
		in, out := &in.ValueFromDetail, &out.ValueFromDetail
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProvisioningRequestPodSetUpdate.
func (in *ProvisioningRequestPodSetUpdate) DeepCopy() *ProvisioningRequestPodSetUpdate {
	if in == nil {
		return nil
	}
	out := new(ProvisioningRequestPodSetUpdate)
	in.DeepCopyInto(out)
	return out
}
