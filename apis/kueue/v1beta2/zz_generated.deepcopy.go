...
func (in *ClusterQueuePreemption) DeepCopyInto(out *ClusterQueuePreemption) {
	*out = *in
	...
	if in.WithinClusterQueueConfig != nil {
		in, out := &in.WithinClusterQueueConfig, &out.WithinClusterQueueConfig
		*out = new(WithinClusterQueueConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WithinClusterQueueConfig) DeepCopyInto(out *WithinClusterQueueConfig) {
	*out = *in
	if in.MinAdmitDurationSeconds != nil {
		in, out := &in.MinAdmitDurationSeconds, &out.MinAdmitDurationSeconds
		*out = new(int32)
		**out = **in
	}
	if in.OpportunisticMinAdmitDurationSeconds != nil {
		in, out := &in.OpportunisticMinAdmitDurationSeconds, &out.OpportunisticMinAdmitDurationSeconds
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WithinClusterQueueConfig.
func (in *WithinClusterQueueConfig) DeepCopy() *WithinClusterQueueConfig {
	if in == nil {
		return nil
	}
	out := new(WithinClusterQueueConfig)
