...
// +kubebuilder:printcolumn:name="Active",JSONPath=".status.conditions[?(@.type=='Active')].status",type=string,description="Status of the LocalQueue's Active condition",priority=1
