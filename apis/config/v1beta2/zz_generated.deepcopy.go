...
func (in *Configuration) DeepCopyInto(out *Configuration) {
	*out = *in
	...
	if in.ReclaimBackoff != nil {
		in, out := &in.ReclaimBackoff, &out.ReclaimBackoff
		*out = new(ReclaimBackoff)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReclaimBackoff) DeepCopyInto(out *ReclaimBackoff) {
	*out = *in
	if in.Enable != nil {
		in, out := &in.Enable, &out.Enable
		*out = new(bool)
	...
	if in.BackoffResetSeconds != nil {
		in, out := &in.BackoffResetSeconds, &out.BackoffResetSeconds
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReclaimBackoff.
func (in *ReclaimBackoff) DeepCopy() *ReclaimBackoff {
	if in == nil {
		return nil
	}
	out := new(ReclaimBackoff)
