...
func (in *ControllerMetrics) DeepCopyInto(out *ControllerMetrics) {
	*out = *in
	...
	if in.TASMetrics != nil {
		in, out := &in.TASMetrics, &out.TASMetrics
		*out = new(TASMetrics)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TASMetrics) DeepCopyInto(out *TASMetrics) {
	*out = *in
	if in.ExcludedTopologyLevels != nil {
		in, out := &in.ExcludedTopologyLevels, &out.ExcludedTopologyLevels
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TASMetrics.
func (in *TASMetrics) DeepCopy() *TASMetrics {
	if in == nil {
		return nil
	}
	out := new(TASMetrics)
