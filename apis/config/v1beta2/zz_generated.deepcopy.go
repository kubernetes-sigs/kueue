...
func (in *MultiKueue) DeepCopyInto(out *MultiKueue) {
	*out = *in
	...
	if in.ObjectRetentionPolicies != nil {
		in, out := &in.ObjectRetentionPolicies, &out.ObjectRetentionPolicies
		*out = new(MultiKueueObjectRetentionPolicies)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiKueueObjectRetentionPolicies) DeepCopyInto(out *MultiKueueObjectRetentionPolicies) {
	*out = *in
	if in.RemoteObjects != nil {
		in, out := &in.RemoteObjects, &out.RemoteObjects
		*out = new(RemoteObjectRetentionPolicy)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiKueueObjectRetentionPolicies.
func (in *MultiKueueObjectRetentionPolicies) DeepCopy() *MultiKueueObjectRetentionPolicies {
	if in == nil {
		return nil
	}
	out := new(MultiKueueObjectRetentionPolicies)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteObjectRetentionPolicy) DeepCopyInto(out *RemoteObjectRetentionPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteObjectRetentionPolicy.
func (in *RemoteObjectRetentionPolicy) DeepCopy() *RemoteObjectRetentionPolicy {
	if in == nil {
		return nil
	}
	out := new(RemoteObjectRetentionPolicy)
...
func (in *WaitForPodsReady) DeepCopyInto(out *WaitForPodsReady) {
	*out = *in
	...
	if in.MaxTimeoutOnWorkload != nil {
		in, out := &in.MaxTimeoutOnWorkload, &out.MaxTimeoutOnWorkload
		*out = new(v1.Duration)
		**out = **in
	}
}
