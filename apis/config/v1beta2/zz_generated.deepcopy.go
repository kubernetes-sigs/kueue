...
func (in *Configuration) DeepCopyInto(out *Configuration) {
	*out = *in
	...
	if in.PreemptionProtection != nil {
		in, out := &in.PreemptionProtection, &out.PreemptionProtection
		*out = new(PreemptionProtection)
		(*in).DeepCopyInto(*out)
	}
	if in.Resources != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreemptionProtection) DeepCopyInto(out *PreemptionProtection) {
	*out = *in
	if in.FairSharing != nil {
		in, out := &in.FairSharing, &out.FairSharing
		*out = new(PreemptionProtectionPolicy)
		(*in).DeepCopyInto(*out)
	}
	if in.ReclaimWithinCohort != nil {
		in, out := &in.ReclaimWithinCohort, &out.ReclaimWithinCohort
		*out = new(PreemptionProtectionPolicy)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreemptionProtection.
func (in *PreemptionProtection) DeepCopy() *PreemptionProtection {
	if in == nil {
		return nil
	}
	out := new(PreemptionProtection)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreemptionProtectionPolicy) DeepCopyInto(out *PreemptionProtectionPolicy) {
	*out = *in
	if in.MinAdmitDuration != nil {
		in, out := &in.MinAdmitDuration, &out.MinAdmitDuration
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreemptionProtectionPolicy.
func (in *PreemptionProtectionPolicy) DeepCopy() *PreemptionProtectionPolicy {
	if in == nil {
		return nil
	}
	out := new(PreemptionProtectionPolicy)
