...
func (in *MultiKueue) DeepCopyInto(out *MultiKueue) {
	*out = *in
	...
	if in.Dispatcher != nil {
		...
		*out = new(MultiKueueWorkloadDispatcher)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiKueueWorkloadDispatcher) DeepCopyInto(out *MultiKueueWorkloadDispatcher) {
	*out = *in
	...
	if in.RoundTimeout != nil {
		in, out := &in.RoundTimeout, &out.RoundTimeout
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiKueueWorkloadDispatcher.
func (in *MultiKueueWorkloadDispatcher) DeepCopy() *MultiKueueWorkloadDispatcher {
	if in == nil {
		return nil
	}
	out := new(MultiKueueWorkloadDispatcher)
