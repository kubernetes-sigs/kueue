...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*ResourceTransformation)(nil), (*v1beta2.ResourceTransformation)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1beta2.ResourceTransformation)(nil), (*ResourceTransformation)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1beta2_ResourceTransformation_To_v1beta1_ResourceTransformation(in *v1beta2.ResourceTransformation, out *ResourceTransformation, s conversion.Scope) error {
	...
	// WARNING: in.MultiplyBy requires manual conversion: does not exist in peer-type
	out.Outputs = *(*v1.ResourceList)(unsafe.Pointer(&in.Outputs))
	return nil
}
...
func autoConvert_v1beta1_Resources_To_v1beta2_Resources(in *Resources, out *v1beta2.Resources, s conversion.Scope) error {
	...
	if in.Transformations != nil {
		...
		*out = make([]v1beta2.ResourceTransformation, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_ResourceTransformation_To_v1beta2_ResourceTransformation(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.Transformations = nil
	}
...
func autoConvert_v1beta2_Resources_To_v1beta1_Resources(in *v1beta2.Resources, out *Resources, s conversion.Scope) error {
	...
	if in.Transformations != nil {
		...
		*out = make([]ResourceTransformation, len(*in))
		for i := range *in {
			if err := Convert_v1beta2_ResourceTransformation_To_v1beta1_ResourceTransformation(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
