...
func (in *ClusterQueue) DeepCopyInto(out *ClusterQueue) {
	*out = *in
	...
	in.PendingWorkloadsSummary.DeepCopyInto(&out.PendingWorkloadsSummary)
	in.RunningWorkloadsSummary.DeepCopyInto(&out.RunningWorkloadsSummary)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunningWorkload) DeepCopyInto(out *RunningWorkload) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.AdmissionTime.DeepCopyInto(&out.AdmissionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunningWorkload.
func (in *RunningWorkload) DeepCopy() *RunningWorkload {
	if in == nil {
		return nil
	}
	out := new(RunningWorkload)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunningWorkloadOptions) DeepCopyInto(out *RunningWorkloadOptions) {
	*out = *in
	out.TypeMeta = in.TypeMeta
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunningWorkloadOptions.
func (in *RunningWorkloadOptions) DeepCopy() *RunningWorkloadOptions {
	if in == nil {
		return nil
	}
	out := new(RunningWorkloadOptions)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RunningWorkloadOptions) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunningWorkloadsSummary) DeepCopyInto(out *RunningWorkloadsSummary) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RunningWorkload, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunningWorkloadsSummary.
func (in *RunningWorkloadsSummary) DeepCopy() *RunningWorkloadsSummary {
	if in == nil {
		return nil
	}
	out := new(RunningWorkloadsSummary)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RunningWorkloadsSummary) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunningWorkloadsSummaryList) DeepCopyInto(out *RunningWorkloadsSummaryList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RunningWorkloadsSummary, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunningWorkloadsSummaryList.
func (in *RunningWorkloadsSummaryList) DeepCopy() *RunningWorkloadsSummaryList {
	if in == nil {
		return nil
	}
	out := new(RunningWorkloadsSummaryList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RunningWorkloadsSummaryList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
