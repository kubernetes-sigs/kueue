...
replace github.com/kubeflow/spark-operator/v2 => github.com/everpeace/spark-operator/v2 v2.0.0-20251016011543-7d98907dd865
...
require (
	...
	github.com/kubeflow/spark-operator/v2 v2.0.0-20251013220706-804428617069
