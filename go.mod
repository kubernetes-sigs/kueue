...
require (
	...
	github.com/kubeflow/spark-operator v0.0.0-00010101000000-000000000000
...
replace github.com/kubeflow/spark-operator => github.com/everpeace/spark-operator v0.0.0-20250120104544-7f87e6564ab4
