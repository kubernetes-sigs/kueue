...
// The two paths an exact Amount costs something on: folding usage and cloning a node.
...
// One share per candidate per ancestor; operands inside int64 and past it.
