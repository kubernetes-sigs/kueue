...
func TestFindTopologyAssignments(t *testing.T) {
	...
	for name, tc := range cases {
		t.Run(name, func(t *testing.T) {
			...
			gotResult := snapshot.FindTopologyAssignmentsForFlavor(flavorTASRequests, log, findOpts...)
...
func TestFindTopologyAssignmentsMultiLayerReplacement(t *testing.T) {
	...
	for name, tc := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result := snapshot.FindTopologyAssignmentsForFlavor(flavorTASRequests, log, WithWorkload(wl))
