...
func TestFindTopologyAssignments(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"topology spreading: cold start, no matching Workload placed yet": {
			...
			levels: defaultThreeLevels,
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired}},
			},
		...
		"topology spreading: an over-allowance domain loses to an empty one": {
			...
			levels: defaultThreeLevels,
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.5"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired}},
			},
		...
		"topology spreading: Preferred rule only deprioritizes the over-allowance domain": {
			...
			levels: defaultThreeLevels,
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModePreferred}},
			},
			spreadCounts: PodSetGroupNameToTreeCount{spreadKeyForPodSetName("main"): {Total: 4, ByDomain: map[tas.TopologyDomainID]int32{"b1": 3, "b2": 1}}},
			podSets: []PodSetTestCase{{
				podSetName:      "main",
		...
		"topology spreading: the least occupied domain wins once all of them are over the allowance": {
			...
			levels: defaultThreeLevels,
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.2"), EnforcementMode: kueue.TopologySpreadingEnforcementModePreferred}},
			},
		...
		"topology spreading: rule below the requested topology level is rejected": {
			...
			levels: defaultThreeLevels,
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {{TopologyKey: tasRackLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired}},
			},
			spreadCounts: PodSetGroupNameToTreeCount{spreadKeyForPodSetName("main"): {}},
			podSets: []PodSetTestCase{{
				podSetName:      "main",
		...
		"topology spreading: two rules constrain the block and the rack": {
			...
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {
					{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.5"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired},
					{TopologyKey: tasRackLabel, MaxShareAllowingPlacement: resource.MustParse("0.5"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired},
				},
			},
			spreadCounts: PodSetGroupNameToTreeCount{
		...
		"topology spreading: a Required block rule combines with a Preferred rack rule": {
			...
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {
					{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.5"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired},
					{TopologyKey: tasRackLabel, MaxShareAllowingPlacement: resource.MustParse("0.5"), EnforcementMode: kueue.TopologySpreadingEnforcementModePreferred},
				},
			},
			spreadCounts: PodSetGroupNameToTreeCount{
				spreadKeyForPodSetName("main"): {Total: 10, ByDomain: map[tas.TopologyDomainID]int32{"b1": 6, "b1,r1": 2, "b1,r2": 4, "b2": 4, "b2,r1": 3, "b2,r2": 1}},
		...
		"topology spreading: the block rule outranks the rack rule": {
			...
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForPodSetName("main"): {
					{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModePreferred},
					{TopologyKey: tasRackLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModePreferred},
				},
			},
			spreadCounts: PodSetGroupNameToTreeCount{
		...
		"topology spreading: PodSet groups are constrained independently": {
			...
			spreadingRules: map[tas.PodSetGroupKey][]tas.SpreadingRule{
				spreadKeyForGroupName("group-a"): {
					{TopologyKey: tasBlockLabel, MaxShareAllowingPlacement: resource.MustParse("0.34"), EnforcementMode: kueue.TopologySpreadingEnforcementModeRequired},
				},
