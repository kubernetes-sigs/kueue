...
type schedulingHashCounts struct {
	...
	// inflight counts hashes of workloads popped by the scheduler but
...
// records it as an inflight hash.
...
// removeInflight removes wInfo's hash from the inflight bucket.
...
// clearInflight forgets all inflight hashes.
