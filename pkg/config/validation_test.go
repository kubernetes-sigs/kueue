...
func TestLoadAndValidateFeatureGates(t *testing.T) {
	cases := map[string]struct {
		...
		"TASFailedNodeReplacement requires TopologyAwareScheduling": {
			...
			errorStr: "TASFailedNodeReplacement requires TopologyAwareScheduling to be enabled",
		},
		"TASBalancedPlacement requires TopologyAwareScheduling": {
			...
			errorStr: "TASBalancedPlacement requires TopologyAwareScheduling to be enabled",
		},
		"TASReplaceNodeOnNodeTaints requires TopologyAwareScheduling": {
			...
			errorStr: "TASReplaceNodeOnNodeTaints requires TopologyAwareScheduling to be enabled",
		},
		"TASFailedNodeReplacementFailFast requires TASFailedNodeReplacement": {
			...
			errorStr: "TASFailedNodeReplacementFailFast requires TASFailedNodeReplacement to be enabled",
		},
		"TASReplaceNodeOnPodTermination requires TASFailedNodeReplacement": {
			...
			errorStr: "TASReplaceNodeOnPodTermination requires TASFailedNodeReplacement to be enabled",
		},
		"TASFailedNodeReplacementFailFast requires both TopologyAwareScheduling": {
			featureGateMap: map[string]bool{
				string(features.TopologyAwareScheduling):          false,
				string(features.TASProfileMixed):                  false,
				string(features.TASHandleOverlappingFlavors):      false,
			...
			errorStr: "TASFailedNodeReplacementFailFast requires TopologyAwareScheduling to be enabled",
		},
		"TASReplaceNodeOnPodTermination requires TopologyAwareScheduling": {
			featureGateMap: map[string]bool{
				string(features.TopologyAwareScheduling):          false,
				string(features.TASProfileMixed):                  false,
				string(features.TASHandleOverlappingFlavors):      false,
			...
			errorStr: "TASReplaceNodeOnPodTermination requires TopologyAwareScheduling to be enabled",
		},
