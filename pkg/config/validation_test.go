...
func TestValidate(t *testing.T) {
	...
	defaultIntegrations := &configapi.Integrations{
		Frameworks: []configapi.KueueIntegrations{configapi.BatchJob},
	...
	testCases := map[string]struct {
		...
		"unregistered integrations.frameworks": {
			cfg: &configapi.Configuration{
				Integrations: &configapi.Integrations{
					Frameworks: []configapi.KueueIntegrations{"unregistered/jobframework"},
				},
			},
			wantErr: field.ErrorList{
				&field.Error{
		...
		"duplicate frameworks between integrations.frameworks and integrations.externalFrameworks": {
			cfg: &configapi.Configuration{
				Integrations: &configapi.Integrations{
					Frameworks:         []configapi.KueueIntegrations{"batch/job"},
		...
		"nil PodIntegrationOptions and nil managedJobsNamespaceSelector with mjns feature gate disabled": {
			cfg: &configapi.Configuration{
				...
				Integrations: &configapi.Integrations{
					Frameworks: []configapi.KueueIntegrations{"pod"},
					PodOptions: nil,
				},
			},
