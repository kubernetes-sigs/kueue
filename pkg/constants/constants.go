...
const (
	...
	// AutoGeneratedLabel is the label added to auto-generated LocalQueues.
	AutoGeneratedLabel = "kueue.x-k8s.io/auto-generated"
	// ClusterQueueAnnotation is the annotation added to auto-generated LocalQueues
	// that references the ClusterQueue that generated them.
	ClusterQueueAnnotation = "kueue.x-k8s.io/cluster-queue"
)
