			...
			wantEvents: []utiltesting.EventRecord{
				{
					...
					EventType: "Warning",
					Reason:    "Pending",
					Message:   "couldn't assign flavors to pod set one: topology domain(s) allow to fit only 1 out of 2 pods",
				},
			},
		},
			...
			wantEvents: []utiltesting.EventRecord{
				{
					...
					EventType: "Warning",
					Reason:    "Pending",
					Message:   "couldn't assign flavors to pod set one: topology domain(s) don't allow to fit any of 1 pods",
				},
			},
		},
