...
type drainScenario struct {
	...
	wantChainDepth int
	// wantWastedPops states that refill must pop workloads it then defers,
	// which is the cost the Fit-only rule imposes on a contended cohort.
	wantWastedPops bool
