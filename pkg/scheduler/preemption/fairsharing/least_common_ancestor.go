...
import "sigs.k8s.io/kueue/pkg/cache/scheduler"
...
func getLCA(t *TargetClusterQueue) *scheduler.CohortSnapshot {
...
func getAlmostLCA(cq *scheduler.ClusterQueueSnapshot, lca *scheduler.CohortSnapshot) almostLCA {
