...
import schedulercache "sigs.k8s.io/kueue/pkg/cache/scheduler"
...
func getLCA(t *TargetClusterQueue) *schedulercache.CohortSnapshot {
...
func getAlmostLCA(cq *schedulercache.ClusterQueueSnapshot, lca *schedulercache.CohortSnapshot) almostLCA {
