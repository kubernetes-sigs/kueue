...
func (p *Preemptor) GetTargets(log logr.Logger, wl workload.Info, assignment flavorassigner.Assignment, snapshot *cache.Snapshot, excludeWorkloads PreemptedWorkloads) []*Target {
