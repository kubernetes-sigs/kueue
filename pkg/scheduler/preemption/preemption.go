...
func resourceUsagePreemptionEnabled(a, b *workload.Info) bool {
	...
	return a.ClusterQueue == b.ClusterQueue && a.Obj.Spec.QueueName != b.Obj.Spec.QueueName && a.LocalQueueUsage != nil && b.LocalQueueUsage != nil
}
...
func CandidatesOrdering(a, b *workload.Info, cq kueue.ClusterQueueReference, now time.Time) bool {
	...
	if resourceUsagePreemptionEnabled(a, b) {
		if a.LocalQueueUsage != b.LocalQueueUsage {
			return *a.LocalQueueUsage < *b.LocalQueueUsage
		}
	}
