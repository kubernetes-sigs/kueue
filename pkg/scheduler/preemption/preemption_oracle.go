...
func NewOracle(preemptor *Preemptor, snapshot *scheduler.Snapshot) *PreemptionOracle {
...
func (p *PreemptionOracle) SimulatePreemption(log logr.Logger, cq *scheduler.ClusterQueueSnapshot, wl workload.Info, fr resources.FlavorResource, quantity int64) (preemptioncommon.PreemptionPossibility, int) {
