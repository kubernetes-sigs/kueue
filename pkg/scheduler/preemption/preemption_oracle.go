...
func NewOracle(preemptor *Preemptor, snapshot *schedulercache.Snapshot) *PreemptionOracle {
...
func (p *PreemptionOracle) SimulatePreemption(log logr.Logger, cq *schedulercache.ClusterQueueSnapshot, wl workload.Info, fr resources.FlavorResource, quantity int64) (preemptioncommon.PreemptionPossibility, int) {
