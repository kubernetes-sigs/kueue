...
var snapCmpOpts = cmp.Options{
	...
	cmp.AllowUnexported(hierarchy.Manager[*schedulercache.ClusterQueueSnapshot, *schedulercache.CohortSnapshot]{}),
	cmpopts.IgnoreFields(hierarchy.Manager[*schedulercache.ClusterQueueSnapshot, *schedulercache.CohortSnapshot]{}, "cohortFactory"),
	cmpopts.IgnoreFields(schedulercache.CohortSnapshot{}, "Cohort"),
	cmp.AllowUnexported(schedulercache.ClusterQueueSnapshot{}),
	cmpopts.IgnoreFields(schedulercache.ClusterQueueSnapshot{}, "ClusterQueue"),
}
