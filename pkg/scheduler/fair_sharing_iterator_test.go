...
// inserted into a running iteration is ranked against the state at the next
// pop, not against the ranking the cycle started with. Consumers of mid-cycle
// re-entry beyond refill depend on the same contract.
