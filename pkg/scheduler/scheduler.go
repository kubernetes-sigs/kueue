...
func (s *Scheduler) getAssignments(log logr.Logger, wl *workload.Info, snap *cache.Snapshot, excludeWorkloads preemption.PreemptedWorkloads) (flavorassigner.Assignment, []*preemption.Target) {
...
func (s *Scheduler) getInitialAssignments(log logr.Logger, wl *workload.Info, snap *cache.Snapshot, excludeWorkloads preemption.PreemptedWorkloads) (flavorassigner.Assignment, []*preemption.Target) {
	cq := snap.ClusterQueue(wl.ClusterQueue)
