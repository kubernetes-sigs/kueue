...
var (
	...
	cipherSuiteMap = map[config.CipherSuite]uint16{
		...
		config.CipherSuiteTLSRSAWithAES128CBCSHA:                  tls.TLS_RSA_WITH_AES_128_CBC_SHA,
		config.CipherSuiteTLSRSAWithAES256CBCSHA:                  tls.TLS_RSA_WITH_AES_256_CBC_SHA,
		config.CipherSuiteTLSRSAWithAES128GCMSHA256:               tls.TLS_RSA_WITH_AES_128_GCM_SHA256,
		config.CipherSuiteTLSRSAWithAES256GCMSHA384:               tls.TLS_RSA_WITH_AES_256_GCM_SHA384,
