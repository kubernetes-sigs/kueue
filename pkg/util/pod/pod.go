...
// GenerateRoleHash will filter all the fields of the pod spec that are relevant to admission (pod role)
// and return a sha256 checksum of those fields. This is used to group the pods of the same roles when
