...
func Matches(domainLabels map[string]string, objectLabels map[string]string) bool {
	for labelKey, labelValue := range objectLabels {
		value, found := domainLabels[labelKey]
