...
type TrainJobWrapper struct{ kftrainerv2api.TrainJob }

// MakeTrainJob creates a wrapper for a suspended TrainJob
func MakeTrainJob(name, ns string) *TrainJobWrapper {
	return &TrainJobWrapper{kftrainerv2api.TrainJob{
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: ns,
		},
		Spec: kftrainerv2api.TrainJobSpec{
			Suspend: ptr.To(true),
			Trainer: &kftrainerv2api.Trainer{
...
func (t *TrainJobWrapper) PodSpecOverrides(overrides []kftrainerv2api.PodSpecOverride) *TrainJobWrapper {
...
func (t *TrainJobWrapper) Obj() *kftrainerv2api.TrainJob {
	return &t.TrainJob
}
...
func (t *TrainJobWrapper) JobsStatus(statuses ...kftrainerv2api.JobStatus) *TrainJobWrapper {
...
func MakeJobSetWrapperFromTrainjob(t *kftrainerv2api.TrainJob) *testingjobset.JobSetWrapper {
	return testingjobset.MakeJobSet(t.Name, t.Namespace).OwnerReference(t.Name, kftrainerv2api.GroupVersion.WithKind("TrainJob"))
}
