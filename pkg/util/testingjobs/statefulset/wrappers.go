...
func (ss *StatefulSetWrapper) PodTemplateSpecPodGroupNameLabel(groupName string) *StatefulSetWrapper {
	return ss.PodTemplateSpecLabel(pod.GroupNameLabel, groupName)
}
