...
func Test_GetResourceRequests(t *testing.T) {
	...
	_ = kueuev1beta2.AddToScheme(scheme)
	...
	tests := []struct {
		name         string
		modifyWL     func(w *kueuev1beta2.Workload)
		extraObjects []runtime.Object
		lookup       func(corev1.ResourceName) (corev1.ResourceName, bool)
		want         map[kueuev1beta2.PodSetReference]corev1.ResourceList
		wantErr      bool
	}{
		{
		...
		},
		{
			...
			want: map[kueuev1beta2.PodSetReference]corev1.ResourceList{"main": {"res-1": resource.MustParse("2"), "res-2": resource.MustParse("1")}},
		},
		{
			...
			want: map[kueuev1beta2.PodSetReference]corev1.ResourceList{"main": {"res-1": resource.MustParse("2")}},
		},
		{
