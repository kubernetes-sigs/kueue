...
func ReportEvictedWorkloadsOnce(cqName kueue.ClusterQueueReference, reason, detailedReason string) {
	EvictedWorkloadsOnceTotal.WithLabelValues(string(cqName), reason, detailedReason).Inc()
}
