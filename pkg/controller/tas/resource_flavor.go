...
func newRfReconciler(c client.Client, queues *queuecache.Manager, cache *schedulercache.Cache, recorder record.EventRecorder) *rfReconciler {
	return &rfReconciler{
...
func (r *rfReconciler) setupWithManager(mgr ctrl.Manager, cache *schedulercache.Cache, cfg *configapi.Configuration) (string, error) {
