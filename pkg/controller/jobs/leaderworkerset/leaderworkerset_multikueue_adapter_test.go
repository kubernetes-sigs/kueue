	...
	cases := map[string]struct {
			...
			workload: &kueue.Workload{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"kueue.x-k8s.io/workload-group-index": "0",
					},
				},
			},
			wantIndex: 0,
		...
		"workload with index 5": {
			workload: &kueue.Workload{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"kueue.x-k8s.io/workload-group-index": "5",
					},
				},
			},
			wantIndex: 5,
		...
		"workload with index 10": {
			workload: &kueue.Workload{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"kueue.x-k8s.io/workload-group-index": "10",
					},
				},
			},
			wantIndex: 10,
		...
		"workload with index 100": {
			workload: &kueue.Workload{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"kueue.x-k8s.io/workload-group-index": "100",
					},
				},
			},
			wantIndex: 100,
		...
		"workload with non-numeric index": {
			workload: &kueue.Workload{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						"kueue.x-k8s.io/workload-group-index": "abc",
					},
				},
			},
			wantIndex: -1,
