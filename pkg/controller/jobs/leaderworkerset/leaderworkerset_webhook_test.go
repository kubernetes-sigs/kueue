	...
	testCases := map[string]struct {
		...
		"invalid PodSet grouping request - required topology request does not match": {
			lws: testingleaderworkerset.MakeLeaderWorkerSet("test-lws", "").
				...
				Obj(),
			wantErr: field.ErrorList{
				field.Invalid(field.NewPath("spec.leaderWorkerTemplate.workerTemplate.metadata.annotations[kueue.x-k8s.io/podset-required-topology]"), "cloud.com/rack", "has to match 'spec.leaderWorkerTemplate.leaderTemplate.metadata.annotations[kueue.x-k8s.io/podset-required-topology]'"),
				field.Invalid(field.NewPath("spec.leaderWorkerTemplate.leaderTemplate.metadata.annotations[kueue.x-k8s.io/podset-required-topology]"), "cloud.com/block", "has to match 'spec.leaderWorkerTemplate.workerTemplate.metadata.annotations[kueue.x-k8s.io/podset-required-topology]'"),
			}.ToAggregate(),
			topologyAwareScheduling: true,
		},
		"invalid PodSet grouping request - preferred topology request does not match": {
			lws: testingleaderworkerset.MakeLeaderWorkerSet("test-lws", "").
				...
				Obj(),
			wantErr: field.ErrorList{
				field.Invalid(field.NewPath("spec.leaderWorkerTemplate.workerTemplate.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]"), "cloud.com/rack", "has to match 'spec.leaderWorkerTemplate.leaderTemplate.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]'"),
				field.Invalid(field.NewPath("spec.leaderWorkerTemplate.leaderTemplate.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]"), "cloud.com/block", "has to match 'spec.leaderWorkerTemplate.workerTemplate.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]'"),
			}.ToAggregate(),
			topologyAwareScheduling: true,
		},
	}
