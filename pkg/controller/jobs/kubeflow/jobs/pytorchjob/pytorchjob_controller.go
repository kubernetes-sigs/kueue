...
var (
	...
	SetupPyTorchJobWebhook = jobframework.BaseWebhookFactory(
		...
		func(o *kftraining.PyTorchJob) jobframework.GenericJob {
			return fromObject(o)
		},
	)
)

var _ admission.Defaulter[*kftraining.PyTorchJob] = &jobframework.BaseWebhook[*kftraining.PyTorchJob]{}
var _ admission.Validator[*kftraining.PyTorchJob] = &jobframework.BaseWebhook[*kftraining.PyTorchJob]{}
