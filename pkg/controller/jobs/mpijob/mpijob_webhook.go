...
func (w *MpiJobWebhook) Default(ctx context.Context, obj *v2beta1.MPIJob) error {
	...
	if err := jobframework.ApplyDefaultWorkloadPriorityClassWithManagedJobsNamespaceSelector(ctx, w.client, mpiJob.Object(), w.managedJobsNamespaceSelector); err != nil {
		return err
	}
