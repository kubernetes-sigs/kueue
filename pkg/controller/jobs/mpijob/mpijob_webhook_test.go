...
func TestValidateCreate(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			wantErr: field.ErrorList{
				field.Invalid(field.NewPath("spec.mpiReplicaSpecs[Launcher].template.metadata.annotations").
					Key("kueue.x-k8s.io/podset-required-topology"), "cloud.com/block", "has to match 'spec.mpiReplicaSpecs[Worker].template.metadata.annotations[kueue.x-k8s.io/podset-required-topology]'"),
				field.Invalid(field.NewPath("spec.mpiReplicaSpecs[Worker].template.metadata.annotations").
					Key("kueue.x-k8s.io/podset-required-topology"), "cloud.com/rack", "has to match 'spec.mpiReplicaSpecs[Launcher].template.metadata.annotations[kueue.x-k8s.io/podset-required-topology]'"),
			}.ToAggregate(),
			topologyAwareScheduling: true,
		},
		{
			...
			wantErr: field.ErrorList{
				field.Invalid(field.NewPath("spec.mpiReplicaSpecs[Launcher].template.metadata.annotations").
					Key("kueue.x-k8s.io/podset-preferred-topology"), "cloud.com/block", "has to match 'spec.mpiReplicaSpecs[Worker].template.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]'"),
				field.Invalid(field.NewPath("spec.mpiReplicaSpecs[Worker].template.metadata.annotations").
					Key("kueue.x-k8s.io/podset-preferred-topology"), "cloud.com/rack", "has to match 'spec.mpiReplicaSpecs[Launcher].template.metadata.annotations[kueue.x-k8s.io/podset-preferred-topology]'"),
			}.ToAggregate(),
			topologyAwareScheduling: true,
		},
	}
