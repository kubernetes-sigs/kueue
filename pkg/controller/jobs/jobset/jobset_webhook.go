...
func (w *JobSetWebhook) validateTopologyRequest(jobSet *JobSet) field.ErrorList {
	...
	for i := range jobSet.Spec.ReplicatedJobs {
		...
		allErrs = append(allErrs, jobframework.ValidateTASPodSetRequestForJob(jobSet, replicaMetaPath, &jobSet.Spec.ReplicatedJobs[i].Template.Spec.Template.ObjectMeta)...)
	}
	return allErrs
}
