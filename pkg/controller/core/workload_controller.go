...
func NewWorkloadReconciler(client client.Client, queues *queuecache.Manager, cache *schedulercache.Cache, recorder record.EventRecorder, options ...Option) *WorkloadReconciler {
