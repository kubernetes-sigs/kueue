...
func (r *WorkloadReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	hasExtendedResourcesDRA := dra.HasExtendedResourcesBackedByDRA(ctx, r.client, &wl)
...
func (r *WorkloadReconciler) Create(e event.TypedCreateEvent[*kueue.Workload]) bool {
	...
	if features.Enabled(features.DRAExtendedResources) && dra.HasExtendedResourcesBackedByDRA(context.Background(), r.client, e.Object) {
...
func (r *WorkloadReconciler) Update(e event.TypedUpdateEvent[*kueue.Workload]) bool {
	...
	case prevStatus == workload.StatusPending && status == workload.StatusPending:
		...
		case features.Enabled(features.DRAExtendedResources) && dra.HasExtendedResourcesBackedByDRA(context.Background(), r.client, e.ObjectNew):
		...
		r.queues.QueueAssociatedInadmissibleWorkloadsAfter(ctx, wlKey, func() {
			...
			if immediate {
				...
				if (features.Enabled(features.DynamicResourceAllocation) && workload.HasDRA(e.ObjectNew)) ||
					(features.Enabled(features.DRAExtendedResources) && dra.HasExtendedResourcesBackedByDRA(context.Background(), r.client, e.ObjectNew)) {
