...
func (r *WorkloadReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !workload.IsAdmitted(&wl) && workload.SyncAdmittedCondition(&wl, r.clock.Now()) {
		if err := workload.PatchAdmissionStatus(ctx, r.client, wlCopy, true, r.clock, func() (*kueue.Workload, bool, error) {
			updated := workload.SyncAdmittedCondition(wlCopy, r.clock.Now())
			return wlCopy, updated, nil
		}); err != nil {
			return ctrl.Result{}, client.IgnoreNotFound(err)
		}
