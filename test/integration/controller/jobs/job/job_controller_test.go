...
var _ = ginkgo.Describe("Job controller", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("When waitForPodsReady enabled", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("Interacting with scheduler", ginkgo.Ordered, func() {
		var (
			ns                  *corev1.Namespace
	...
	ginkgo.Describe("Job controller interacting with Workload controller when waitForPodsReady with requeuing strategy is enabled", ginkgo.Ordered, func() {
		var (
