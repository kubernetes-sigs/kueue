...
func managerAndSchedulerSetup(admissionFairSharing *config.AdmissionFairSharing) framework.ManagerSetup {
	return func(ctx context.Context, mgr manager.Manager) {
		...
		cCache := schedulercache.New(mgr.GetClient(), schedulercache.WithFairSharing(fairSharing.Enable), schedulercache.WithAdmissionFairSharing(admissionFairSharing))
		queues := queuecache.NewManager(mgr.GetClient(), cCache, queuecache.WithAdmissionFairSharing(admissionFairSharing))
