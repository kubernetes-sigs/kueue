...
var _ = ginkgo.Describe("Pod termination controller", func() {
	...
	ginkgo.AfterEach(func() {
		...
		gomega.Expect(client.IgnoreNotFound(k8sClient.Delete(ctx, &corev1.Node{ObjectMeta: metav1.ObjectMeta{Name: unreachableNodeName}}))).To(gomega.Succeed())
		gomega.Expect(client.IgnoreNotFound(k8sClient.Delete(ctx, &corev1.Node{ObjectMeta: metav1.ObjectMeta{Name: reachableNodeName}}))).To(gomega.Succeed())
	})
