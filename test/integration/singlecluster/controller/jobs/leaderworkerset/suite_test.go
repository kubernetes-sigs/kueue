...
func TestAPIs(t *testing.T) {
	behavioral.RunSuite(t, "LeaderWorkerSet Controller Suite")
}

var _ = ginkgo.BeforeSuite(func() {
	fwk = &framework.Framework{
		DepCRDPaths: []string{behavioral.LeaderWorkerSetCrds},
...
func managerSetup(opts ...jobframework.Option) framework.ManagerSetup {
	return func(ctx context.Context, mgr manager.Manager) {
		...
		err = leaderworkerset.SetupWebhook(mgr, setupOpts...)
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
		...
		integrationManager.EnableIntegration(leaderworkerset.FrameworkName)
