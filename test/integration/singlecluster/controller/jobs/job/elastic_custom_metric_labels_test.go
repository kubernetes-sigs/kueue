...
// The ungater is the only reader of the labels on this path, and it is handed
// them by SetupWithManager rather than by an option the other controllers share.
