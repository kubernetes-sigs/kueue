...
func managerSetup(modifyConfig func(*config.Configuration)) framework.ManagerSetup {
	return func(ctx context.Context, mgr manager.Manager) {
		...
		failedCtrl, err := core.SetupControllers(
			...
			cCache,
			controllersCfg,
			core.SetupControllersOpts{PreemptionExpectations: preemptionExpectations, DRAMapper: draMapper, DRABackedResources: draBackedResources, ResourceSliceAPIAvailable: true},
		)
