...
func hasOpenConcurrentAdmissionGate(wl *kueue.Workload) bool {
	return slices.ContainsFunc(wl.Status.PreemptionGates, func(g kueue.PreemptionGateState) bool {
		return g.Name == controllerconstants.ConcurrentAdmissionPreemptionGate &&
