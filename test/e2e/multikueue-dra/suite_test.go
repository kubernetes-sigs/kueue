...
var _ = ginkgo.BeforeSuite(func() {
	...
	// Use MinimalMultiKueueRules for DRA tests - only Jobs, JobSets, Workloads, Pods
	...
	// Wait for JobSet availability on all clusters
	...
	ginkgo.GinkgoLogr.Info(
		"Kueue, JobSet, and DRA example driver are available in all clusters",
