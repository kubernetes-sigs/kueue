...
var _ = ginkgo.Describe("Fair Sharing", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.BeforeEach(func() {
		...
		util.ExpectClusterQueuesToBeActive(ctx, k8sClient, cq1)
		...
		util.ExpectClusterQueuesToBeActive(ctx, k8sClient, cq2)
