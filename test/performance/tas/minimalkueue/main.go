...
func run() int {
	...
	// based on the default config, with TAS support
	options := ctrl.Options{
		...
		Controller: crconfig.Controller{
			...
			GroupKindConcurrency: map[string]int{
				...
				kueue.GroupVersion.WithKind("Topology").GroupKind().String():       1, // TAS support
			},
		},
	...
	log.Info("Starting manager with TAS support")
