...
Requested functionalities from the community can be satisfied with the following configurations (with time-based duration selectors in stories 5 & 6 deferred to [Future Work Ideas](#future-work-ideas)):
