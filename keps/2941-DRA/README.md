...
- re-evaluate interaction with DRAConsumableCapacity (KEP-5075, beta as of Kubernetes 1.36).
...
- re-evaluate relaxing the single counter source limitation per device class mapping
