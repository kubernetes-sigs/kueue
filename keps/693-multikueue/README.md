...
type WorkloadStatus struct {
  ...
  // +kubebuilder:validation:XValidation:rule="self.status.clusterName == null || oldObject.status.nominatedClusterNames == self.status.nominatedClusterNames",message="nominatedClusterNames is immutable when the workload is assigned to a cluster"
  // +optional
