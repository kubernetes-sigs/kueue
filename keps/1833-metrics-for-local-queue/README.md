...
| `LocalQueueSelector`          | Description                                                                                                        |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------|
| -                             | Metrics for all local queues will be exposed.                                                                      |
| Specified                     | All LocalQueues matching the label selector have metrics enabled.                                                  |
| Specified, non-existing label | No metrics will be exposed until a LocalQueue with the specified label is created.
