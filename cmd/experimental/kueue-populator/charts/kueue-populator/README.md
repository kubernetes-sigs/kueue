...
> Note: Replace `<VERSION>` with the desired version of the chart. Check the available versions in the [registry](us-central1-docker.pkg.dev/k8s-staging-images/kueue).
