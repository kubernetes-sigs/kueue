...
E2E_TARGET_FOLDER=singlecluster/wasapi \
...
| `E2E_TARGET_FOLDER` | `singlecluster/wasapi` | Points at the WAS test folder |
...
```bash
KIND_CLUSTER_NAME=was-test go test ./test/e2e/singlecluster/wasapi/... -v -count=1
```
...
KIND_CLUSTER_NAME=was-test go test ./test/e2e/singlecluster/wasapi/... -v -count=1 --ginkgo.label-filter="feature:was-job"
```
