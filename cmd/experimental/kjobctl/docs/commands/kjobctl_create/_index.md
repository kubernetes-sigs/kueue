...
```
kjobctl create job|interactive --profile APPLICATION_PROFILE_NAME [--cmd COMMAND] [--parallelism PARALLELISM] [--completions COMPLETIONS] [--request RESOURCE_NAME=QUANTITY] [--localqueue LOCAL_QUEUE_NAME] [--dry-run STRATEGY]
```
...
<table style="width: 100%; table-layout: fixed;">
    ...
    <tr>
        <td></td>
        <td style="line-height: 130%; word-wrap: break-word;">
            <p>Completions specifies the desired number of successfully finished pods the.</p>
        </td>
    </tr>
    <tr>
