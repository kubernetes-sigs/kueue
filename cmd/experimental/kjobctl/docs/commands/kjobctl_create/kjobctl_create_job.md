...
```
kjobctl create job --profile APPLICATION_PROFILE_NAME [--request RESOURCE_NAME=QUANTITY] [--localqueue LOCAL_QUEUE_NAME] [--cmd COMMAND] [--parallelism PARALLELISM] [--completions COMPLETIONS]
```
