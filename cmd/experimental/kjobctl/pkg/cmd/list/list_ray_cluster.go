...
const (
	rayClusterExample = `  # List RayCluster
...
func NewRayClusterCmd(clientGetter util.ClientGetter, streams genericiooptions.IOStreams, clock clock.Clock) *cobra.Command {
...
func (o *RayClusterOptions) Complete(clientGetter util.ClientGetter) error {
	var err error
