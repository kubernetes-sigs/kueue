...
func (c *rayClusterTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RayClusterTemplate, err error) {
	result = &v1alpha1.RayClusterTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rayclustertemplates").
		Name(name).
...
func (c *rayClusterTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RayClusterTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RayClusterTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rayclustertemplates").
...
func (c *rayClusterTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rayClusterTemplates) Create(ctx context.Context, rayClusterTemplate *v1alpha1.RayClusterTemplate, opts v1.CreateOptions) (result *v1alpha1.RayClusterTemplate, err error) {
	result = &v1alpha1.RayClusterTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rayclustertemplates").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(rayClusterTemplate).
		Do(ctx).
		Into(result)
	return
}
...
func (c *rayClusterTemplates) Update(ctx context.Context, rayClusterTemplate *v1alpha1.RayClusterTemplate, opts v1.UpdateOptions) (result *v1alpha1.RayClusterTemplate, err error) {
	result = &v1alpha1.RayClusterTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rayclustertemplates").
		Name(rayClusterTemplate.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(rayClusterTemplate).
		Do(ctx).
		Into(result)
...
func (c *rayClusterTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *rayClusterTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *rayClusterTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RayClusterTemplate, err error) {
	result = &v1alpha1.RayClusterTemplate{}
