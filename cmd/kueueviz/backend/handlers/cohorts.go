...
func CohortsWebSocketHandler(client Client) gin.HandlerFunc {
	return GenericWebSocketHandler(func(ctx context.Context) (any, error) {
		return fetchCohorts(ctx, client)
	})
}

// CohortDetailsWebSocketHandler streams details for a specific cohort
func CohortDetailsWebSocketHandler(client Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		cohortName := c.Param("cohort_name")

		GenericWebSocketHandler(func(ctx context.Context) (any, error) {
			return fetchCohortDetails(ctx, client, cohortName)
		})(c)
	}
}

// Fetch all cohorts
func fetchCohorts(ctx context.Context, client Client) (any, error) {
...
func fetchCohortDetails(ctx context.Context, client Client, cohortName string) (map[string]any, error) {
