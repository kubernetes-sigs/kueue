...
```
kubectl create -f https://github.com/kubernetes-sigs/kueue/releases/download/v0.13.10/kueueviz.yaml
```
...
helm install kueue oci://us-central1-docker.pkg.dev/k8s-staging-images/charts/kueue \
            --version="0.13.10" --create-namespace --namespace=kueue-system
```
