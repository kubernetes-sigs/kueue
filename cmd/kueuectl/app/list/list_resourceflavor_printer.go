...
func (p *listResourceFlavorPrinter) PrintObj(obj runtime.Object, out io.Writer) error {
	...
	list, ok := obj.(*v1beta2.ResourceFlavorList)
	if !ok {
...
func (p *listResourceFlavorPrinter) printResourceFlavorList(list *v1beta2.ResourceFlavorList) []metav1.TableRow {
...
func (p *listResourceFlavorPrinter) printResourceFlavor(resourceFlavor *v1beta2.ResourceFlavor) metav1.TableRow {
