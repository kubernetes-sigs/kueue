...
func (o *WorkloadOptions) filterList(list *v1beta2.WorkloadList, enableOwnerReferenceFilter bool, uid types.UID) {
	if len(list.Items) == 0 {
		return
	}
	filteredItems := make([]v1beta2.Workload, 0, len(o.LocalQueueFilter))
...
func (o *WorkloadOptions) filterByLocalQueue(wl *v1beta2.Workload) bool {
	return len(o.LocalQueueFilter) == 0 || string(wl.Spec.QueueName) == o.LocalQueueFilter
}

func (o *WorkloadOptions) filterByClusterQueue(wl *v1beta2.Workload) bool {
	return len(o.ClusterQueueFilter) == 0 || wl.Status.Admission != nil &&
		wl.Status.Admission.ClusterQueue == v1beta2.ClusterQueueReference(o.ClusterQueueFilter)
}

func (o *WorkloadOptions) filterByStatuses(wl *v1beta2.Workload) bool {
...
func (o *WorkloadOptions) filterByOwnerReference(wl *v1beta2.Workload, isEnabled bool, uid types.UID) bool {
	if !isEnabled {
		return true
	}
...
func (o *WorkloadOptions) localQueues(ctx context.Context, list *v1beta2.WorkloadList) (map[string]*v1beta2.LocalQueue, error) {
...
func (o *WorkloadOptions) pendingWorkloads(ctx context.Context, list *v1beta2.WorkloadList, localQueues map[string]*v1beta2.LocalQueue) (map[workload.Reference]*visibility.PendingWorkload, error) {
	var err error

	pendingWorkloads := make(map[workload.Reference]*visibility.PendingWorkload)
	pendingWorkloadsSummaries := make(map[v1beta2.ClusterQueueReference]*visibility.PendingWorkloadsSummary)

	for _, wl := range list.Items {
		if !workloadPending(&wl) {
			continue
		}
		var clusterQueueName v1beta2.ClusterQueueReference
		if wl.Status.Admission != nil && len(wl.Status.Admission.ClusterQueue) > 0 {
...
func (o *WorkloadOptions) apiResources(list *v1beta2.WorkloadList) (map[string]*metav1.APIResourceList, error) {
...
func workloadPending(wl *v1beta2.Workload) bool {
	return workload.Status(wl) == workload.StatusPending
}

func localQueueKeyForWorkload(wl *v1beta2.Workload) string {
