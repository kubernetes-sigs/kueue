...
.PHONY: test-e2e-dra-extended
test-e2e-dra-extended: setup-e2e-env run-test-e2e-dra-extended-$(E2E_KIND_VERSION:kindest/node:v%=%)

run-test-e2e-dra-extended-%: K8S_VERSION = $(@:run-test-e2e-dra-extended-%=%)
run-test-e2e-dra-extended-%:
