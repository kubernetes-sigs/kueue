...
TEST_E2E_SHARD_1_TARGETS := test-e2e-extended test-e2e-extended-shard-1 test-e2e-extended-shard-2
...
test-e2e-extended-shard-0: GINKGO_ARGS=--label-filter=feature:appwrapper,feature:jaxjob,feature:jobset,feature:leaderworkerset,feature:pytorchjob,feature:trainjob
...
test-e2e-extended-shard-1: GINKGO_ARGS=--label-filter='feature:kuberay && shard:kuberay-a'
