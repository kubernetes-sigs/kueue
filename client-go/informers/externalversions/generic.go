...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("specifiedcapacities"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kueue().V1alpha1().SpecifiedCapacities().Informer()}, nil
