	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KueueV1alpha1().MultiKueueConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KueueV1alpha1().MultiKueueConfigs().Watch(context.TODO(), options)
			},
		},
		&kueuev1alpha1.MultiKueueConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiKueueConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kueuev1alpha1.MultiKueueConfig{}, f.defaultInformer)
}

func (f *multiKueueConfigInformer) Lister() v1alpha1.MultiKueueConfigLister {
	return v1alpha1.NewMultiKueueConfigLister(f.Informer().GetIndexer())
}
