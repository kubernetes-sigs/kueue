...
type Interface interface {
	...
	// SpecifiedCapacities returns a SpecifiedCapacityInformer.
	SpecifiedCapacities() SpecifiedCapacityInformer
}
...
// SpecifiedCapacities returns a SpecifiedCapacityInformer.
func (v *version) SpecifiedCapacities() SpecifiedCapacityInformer {
	return &specifiedCapacityInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
