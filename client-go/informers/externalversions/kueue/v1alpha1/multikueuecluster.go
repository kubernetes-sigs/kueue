	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KueueV1alpha1().MultiKueueClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KueueV1alpha1().MultiKueueClusters().Watch(context.TODO(), options)
			},
		},
		&kueuev1alpha1.MultiKueueCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiKueueClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kueuev1alpha1.MultiKueueCluster{}, f.defaultInformer)
}

func (f *multiKueueClusterInformer) Lister() v1alpha1.MultiKueueClusterLister {
	return v1alpha1.NewMultiKueueClusterLister(f.Informer().GetIndexer())
}
