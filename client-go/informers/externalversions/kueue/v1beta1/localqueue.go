...
type LocalQueueIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta1.LocalQueue]

// LocalQueueHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for LocalQueue.
type LocalQueueHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta1.LocalQueue]

// LocalQueueDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for LocalQueue.
type LocalQueueDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta1.LocalQueue]

// LocalQueueFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for LocalQueue.
type LocalQueueFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta1.LocalQueue]

// LocalQueueIndexers is a specialization of [cache.TypedIndexers] for LocalQueue.
type LocalQueueIndexers = cache.TypedIndexers[*apiskueuev1beta1.LocalQueue]

// DeletedLocalQueue is a specialization of [cache.DeletedObject] for LocalQueue.
type DeletedLocalQueue = cache.DeletedObject[*apiskueuev1beta1.LocalQueue]
...
func NewTypedLocalQueueInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) LocalQueueIndexInformer {
	gvr := schema.GroupVersionResource{Group: "kueue.x-k8s.io", Version: "v1beta1", Resource: "localqueues"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta1.LocalQueue](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta1().LocalQueues(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta1().LocalQueues(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta1().LocalQueues(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta1().LocalQueues(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *localQueueInformer) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta1.LocalQueue](f.factory.InformerFor(&apiskueuev1beta1.LocalQueue{}, f.defaultInformer))
}
...
func (a *localQueueTypedInformerAdapter) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta1.LocalQueue](a.Informer())
}
...
func ToLocalQueueIndexInformer(informer cache.SharedIndexInformer) LocalQueueIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta1.LocalQueue](informer)
}
