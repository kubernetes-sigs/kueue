...
type ResourceFlavorIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta2.ResourceFlavor]

// ResourceFlavorHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for ResourceFlavor.
type ResourceFlavorHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta2.ResourceFlavor]
...
type ResourceFlavorDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta2.ResourceFlavor]

// ResourceFlavorFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for ResourceFlavor.
type ResourceFlavorFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta2.ResourceFlavor]

// ResourceFlavorIndexers is a specialization of [cache.TypedIndexers] for ResourceFlavor.
type ResourceFlavorIndexers = cache.TypedIndexers[*apiskueuev1beta2.ResourceFlavor]

// DeletedResourceFlavor is a specialization of [cache.DeletedObject] for ResourceFlavor.
type DeletedResourceFlavor = cache.DeletedObject[*apiskueuev1beta2.ResourceFlavor]
...
func NewTypedResourceFlavorInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) ResourceFlavorIndexInformer {
	gvr := schema.GroupVersionResource{Group: "kueue.x-k8s.io", Version: "v1beta2", Resource: "resourceflavors"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.ResourceFlavor](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().ResourceFlavors().List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().ResourceFlavors().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().ResourceFlavors().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().ResourceFlavors().Watch(ctx, opts)
			},
		}, client),
...
func (f *resourceFlavorInformer) TypedInformer() ResourceFlavorIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.ResourceFlavor](f.factory.InformerFor(&apiskueuev1beta2.ResourceFlavor{}, f.defaultInformer))
}
...
func (a *resourceFlavorTypedInformerAdapter) TypedInformer() ResourceFlavorIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.ResourceFlavor](a.Informer())
}
...
func ToResourceFlavorIndexInformer(informer cache.SharedIndexInformer) ResourceFlavorIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.ResourceFlavor](informer)
}
