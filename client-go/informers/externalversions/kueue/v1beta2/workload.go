...
type WorkloadIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta2.Workload]

// WorkloadHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Workload.
type WorkloadHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta2.Workload]

// WorkloadDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Workload.
type WorkloadDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta2.Workload]

// WorkloadFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Workload.
type WorkloadFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta2.Workload]

// WorkloadIndexers is a specialization of [cache.TypedIndexers] for Workload.
type WorkloadIndexers = cache.TypedIndexers[*apiskueuev1beta2.Workload]

// DeletedWorkload is a specialization of [cache.DeletedObject] for Workload.
type DeletedWorkload = cache.DeletedObject[*apiskueuev1beta2.Workload]
...
func NewTypedWorkloadInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) WorkloadIndexInformer {
	gvr := schema.GroupVersionResource{Group: "kueue.x-k8s.io", Version: "v1beta2", Resource: "workloads"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.Workload](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().Workloads(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().Workloads(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().Workloads(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().Workloads(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *workloadInformer) TypedInformer() WorkloadIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.Workload](f.factory.InformerFor(&apiskueuev1beta2.Workload{}, f.defaultInformer))
}
...
func (a *workloadTypedInformerAdapter) TypedInformer() WorkloadIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.Workload](a.Informer())
}
...
func ToWorkloadIndexInformer(informer cache.SharedIndexInformer) WorkloadIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.Workload](informer)
}
