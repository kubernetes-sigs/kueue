...
type MultiKueueConfigIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueConfig]

// MultiKueueConfigHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for MultiKueueConfig.
type MultiKueueConfigHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta2.MultiKueueConfig]
...
type MultiKueueConfigDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta2.MultiKueueConfig]

// MultiKueueConfigFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for MultiKueueConfig.
type MultiKueueConfigFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta2.MultiKueueConfig]

// MultiKueueConfigIndexers is a specialization of [cache.TypedIndexers] for MultiKueueConfig.
type MultiKueueConfigIndexers = cache.TypedIndexers[*apiskueuev1beta2.MultiKueueConfig]

// DeletedMultiKueueConfig is a specialization of [cache.DeletedObject] for MultiKueueConfig.
type DeletedMultiKueueConfig = cache.DeletedObject[*apiskueuev1beta2.MultiKueueConfig]
...
func NewTypedMultiKueueConfigInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) MultiKueueConfigIndexInformer {
	gvr := schema.GroupVersionResource{Group: "kueue.x-k8s.io", Version: "v1beta2", Resource: "multikueueconfigs"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueConfig](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().MultiKueueConfigs().List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().MultiKueueConfigs().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().MultiKueueConfigs().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().MultiKueueConfigs().Watch(ctx, opts)
			},
		}, client),
...
func (f *multiKueueConfigInformer) TypedInformer() MultiKueueConfigIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueConfig](f.factory.InformerFor(&apiskueuev1beta2.MultiKueueConfig{}, f.defaultInformer))
}
...
func (a *multiKueueConfigTypedInformerAdapter) TypedInformer() MultiKueueConfigIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueConfig](a.Informer())
}
...
func ToMultiKueueConfigIndexInformer(informer cache.SharedIndexInformer) MultiKueueConfigIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueConfig](informer)
}
