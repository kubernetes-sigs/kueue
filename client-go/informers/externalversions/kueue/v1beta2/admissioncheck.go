...
type AdmissionCheckIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta2.AdmissionCheck]

// AdmissionCheckHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for AdmissionCheck.
type AdmissionCheckHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta2.AdmissionCheck]
...
type AdmissionCheckDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta2.AdmissionCheck]

// AdmissionCheckFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for AdmissionCheck.
type AdmissionCheckFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta2.AdmissionCheck]

// AdmissionCheckIndexers is a specialization of [cache.TypedIndexers] for AdmissionCheck.
type AdmissionCheckIndexers = cache.TypedIndexers[*apiskueuev1beta2.AdmissionCheck]

// DeletedAdmissionCheck is a specialization of [cache.DeletedObject] for AdmissionCheck.
type DeletedAdmissionCheck = cache.DeletedObject[*apiskueuev1beta2.AdmissionCheck]
...
func NewTypedAdmissionCheckInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) AdmissionCheckIndexInformer {
	gvr := schema.GroupVersionResource{Group: "kueue.x-k8s.io", Version: "v1beta2", Resource: "admissionchecks"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.AdmissionCheck](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().AdmissionChecks().List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().AdmissionChecks().Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().AdmissionChecks().List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.KueueV1beta2().AdmissionChecks().Watch(ctx, opts)
			},
		}, client),
...
func (f *admissionCheckInformer) TypedInformer() AdmissionCheckIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.AdmissionCheck](f.factory.InformerFor(&apiskueuev1beta2.AdmissionCheck{}, f.defaultInformer))
}
...
func (a *admissionCheckTypedInformerAdapter) TypedInformer() AdmissionCheckIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.AdmissionCheck](a.Informer())
}
...
func ToAdmissionCheckIndexInformer(informer cache.SharedIndexInformer) AdmissionCheckIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.AdmissionCheck](informer)
}
