...
type MultiKueueClusterIndexInformer cache.TypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueCluster]

// MultiKueueClusterHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for MultiKueueCluster.
type MultiKueueClusterHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiskueuev1beta2.MultiKueueCluster]
...
type MultiKueueClusterDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiskueuev1beta2.MultiKueueCluster]

// MultiKueueClusterFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for MultiKueueCluster.
type MultiKueueClusterFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiskueuev1beta2.MultiKueueCluster]

// MultiKueueClusterIndexers is a specialization of [cache.TypedIndexers] for MultiKueueCluster.
type MultiKueueClusterIndexers = cache.TypedIndexers[*apiskueuev1beta2.MultiKueueCluster]

// DeletedMultiKueueCluster is a specialization of [cache.DeletedObject] for MultiKueueCluster.
type DeletedMultiKueueCluster = cache.DeletedObject[*apiskueuev1beta2.MultiKueueCluster]
...
func NewTypedMultiKueueClusterInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) MultiKueueClusterIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueCluster](cache.NewSharedIndexInformerWithOptions(
...
func (f *multiKueueClusterInformer) TypedInformer() MultiKueueClusterIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueCluster](f.factory.InformerFor(&apiskueuev1beta2.MultiKueueCluster{}, f.defaultInformer))
}
...
func (a *multiKueueClusterTypedInformerAdapter) TypedInformer() MultiKueueClusterIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueCluster](a.Informer())
}
...
func ToMultiKueueClusterIndexInformer(informer cache.SharedIndexInformer) MultiKueueClusterIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiskueuev1beta2.MultiKueueCluster](informer)
}
