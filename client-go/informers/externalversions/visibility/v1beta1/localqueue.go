...
type LocalQueueIndexInformer cache.TypedSharedIndexInformer[*apisvisibilityv1beta1.LocalQueue]

// LocalQueueHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for LocalQueue.
type LocalQueueHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisvisibilityv1beta1.LocalQueue]

// LocalQueueDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for LocalQueue.
type LocalQueueDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisvisibilityv1beta1.LocalQueue]

// LocalQueueFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for LocalQueue.
type LocalQueueFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisvisibilityv1beta1.LocalQueue]

// LocalQueueIndexers is a specialization of [cache.TypedIndexers] for LocalQueue.
type LocalQueueIndexers = cache.TypedIndexers[*apisvisibilityv1beta1.LocalQueue]

// DeletedLocalQueue is a specialization of [cache.DeletedObject] for LocalQueue.
type DeletedLocalQueue = cache.DeletedObject[*apisvisibilityv1beta1.LocalQueue]
...
func NewTypedLocalQueueInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) LocalQueueIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta1.LocalQueue](cache.NewSharedIndexInformerWithOptions(
...
func (f *localQueueInformer) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta1.LocalQueue](f.factory.InformerFor(&apisvisibilityv1beta1.LocalQueue{}, f.defaultInformer))
}
...
func (a *localQueueTypedInformerAdapter) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta1.LocalQueue](a.Informer())
}
...
func ToLocalQueueIndexInformer(informer cache.SharedIndexInformer) LocalQueueIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta1.LocalQueue](informer)
}
