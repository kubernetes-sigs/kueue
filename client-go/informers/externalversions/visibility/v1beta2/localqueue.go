...
type LocalQueueInformer interface {
	...
	Lister() visibilityv1beta2.LocalQueueLister
}
...
type LocalQueueIndexInformer cache.TypedSharedIndexInformer[*apisvisibilityv1beta2.LocalQueue]

// LocalQueueHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for LocalQueue.
type LocalQueueHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisvisibilityv1beta2.LocalQueue]

// LocalQueueDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for LocalQueue.
type LocalQueueDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisvisibilityv1beta2.LocalQueue]

// LocalQueueFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for LocalQueue.
type LocalQueueFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisvisibilityv1beta2.LocalQueue]

// LocalQueueIndexers is a specialization of [cache.TypedIndexers] for LocalQueue.
type LocalQueueIndexers = cache.TypedIndexers[*apisvisibilityv1beta2.LocalQueue]

// DeletedLocalQueue is a specialization of [cache.DeletedObject] for LocalQueue.
type DeletedLocalQueue = cache.DeletedObject[*apisvisibilityv1beta2.LocalQueue]
...
func NewTypedLocalQueueInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) LocalQueueIndexInformer {
	gvr := schema.GroupVersionResource{Group: "visibility.kueue.x-k8s.io", Version: "v1beta2", Resource: "localqueues"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta2.LocalQueue](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.VisibilityV1beta2().LocalQueues(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.VisibilityV1beta2().LocalQueues(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.VisibilityV1beta2().LocalQueues(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.VisibilityV1beta2().LocalQueues(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisvisibilityv1beta2.LocalQueue{},
...
func (f *localQueueInformer) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta2.LocalQueue](f.factory.InformerFor(&apisvisibilityv1beta2.LocalQueue{}, f.defaultInformer))
}

func (f *localQueueInformer) Lister() visibilityv1beta2.LocalQueueLister {
	return visibilityv1beta2.NewLocalQueueLister(f.Informer().GetIndexer())
}
...
func (a *localQueueTypedInformerAdapter) TypedInformer() LocalQueueIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta2.LocalQueue](a.Informer())
}
...
func ToLocalQueueIndexInformer(informer cache.SharedIndexInformer) LocalQueueIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisvisibilityv1beta2.LocalQueue](informer)
}
