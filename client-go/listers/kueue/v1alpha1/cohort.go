...
type CohortLister interface {
	...
	List(selector labels.Selector) (ret []*kueuev1alpha1.Cohort, err error)
...
type cohortLister struct {
	listers.ResourceIndexer[*kueuev1alpha1.Cohort]
}

// NewCohortLister returns a new CohortLister.
func NewCohortLister(indexer cache.Indexer) CohortLister {
	return &cohortLister{listers.New[*kueuev1alpha1.Cohort](indexer, kueuev1alpha1.Resource("cohort"))}
}

// Cohorts returns an object that can list and get Cohorts.
func (s *cohortLister) Cohorts(namespace string) CohortNamespaceLister {
	return cohortNamespaceLister{listers.NewNamespaced[*kueuev1alpha1.Cohort](s.ResourceIndexer, namespace)}
}
...
type CohortNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kueuev1alpha1.Cohort, error)
