...
type multiKueueConfigLister struct {
	listers.ResourceIndexer[*v1alpha1.MultiKueueConfig]
}
...
func NewMultiKueueConfigLister(indexer cache.Indexer) MultiKueueConfigLister {
	return &multiKueueConfigLister{listers.New[*v1alpha1.MultiKueueConfig](indexer, v1alpha1.Resource("multikueueconfig"))}
}
