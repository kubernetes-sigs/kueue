...
// WithTestString sets the TestString field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the TestString field is set to the value of the last call.
func (b *ClusterQueueSpecApplyConfiguration) WithTestString(value string) *ClusterQueueSpecApplyConfiguration {
	b.TestString = &value
	return b
}
