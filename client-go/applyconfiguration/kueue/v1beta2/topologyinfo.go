...
type TopologyInfoApplyConfiguration struct {
	Name   *kueuev1beta2.TopologyReference `json:"name,omitempty"`
...
func (b *TopologyInfoApplyConfiguration) WithName(value kueuev1beta2.TopologyReference) *TopologyInfoApplyConfiguration {
	b.Name = &value
	return b
}
