...
// ExtractWorkloadPriorityClass extracts the applied configuration owned by fieldManager from
// workloadPriorityClass. If no managedFields are found in workloadPriorityClass for fieldManager, a
// WorkloadPriorityClassApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// workloadPriorityClass must be a unmodified WorkloadPriorityClass API object that was retrieved from the Kubernetes API.
// ExtractWorkloadPriorityClass provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
// Experimental!
func ExtractWorkloadPriorityClass(workloadPriorityClass *kueuev1beta1.WorkloadPriorityClass, fieldManager string) (*WorkloadPriorityClassApplyConfiguration, error) {
	return extractWorkloadPriorityClass(workloadPriorityClass, fieldManager, "")
}

// ExtractWorkloadPriorityClassStatus is the same as ExtractWorkloadPriorityClass except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractWorkloadPriorityClassStatus(workloadPriorityClass *kueuev1beta1.WorkloadPriorityClass, fieldManager string) (*WorkloadPriorityClassApplyConfiguration, error) {
	return extractWorkloadPriorityClass(workloadPriorityClass, fieldManager, "status")
}

func extractWorkloadPriorityClass(workloadPriorityClass *kueuev1beta1.WorkloadPriorityClass, fieldManager string, subresource string) (*WorkloadPriorityClassApplyConfiguration, error) {
	b := &WorkloadPriorityClassApplyConfiguration{}
	err := managedfields.ExtractInto(workloadPriorityClass, internal.Parser().Type("io.k8s.sigs.kueue.apis.kueue.v1beta1.WorkloadPriorityClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(workloadPriorityClass.Name)
