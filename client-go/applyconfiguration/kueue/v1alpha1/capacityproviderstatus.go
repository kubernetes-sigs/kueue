...
type CapacityProviderStatusApplyConfiguration struct {
	...
	Capacity *CapacityProviderSnapshotApplyConfiguration `json:"capacity,omitempty"`
...
func (b *CapacityProviderStatusApplyConfiguration) WithCapacity(value *CapacityProviderSnapshotApplyConfiguration) *CapacityProviderStatusApplyConfiguration {
	b.Capacity = value
	return b
}
