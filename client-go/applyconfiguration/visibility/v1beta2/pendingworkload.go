...
func (b *PendingWorkloadApplyConfiguration) WithLocalQueueName(value kueuev1beta2.LocalQueueName) *PendingWorkloadApplyConfiguration {
...
func (b *PendingWorkloadApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
