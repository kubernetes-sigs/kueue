...
// Experimental!
func ExtractClusterQueue(clusterQueue *visibilityv1beta1.ClusterQueue, fieldManager string) (*ClusterQueueApplyConfiguration, error) {
...
// Experimental!
func ExtractClusterQueueStatus(clusterQueue *visibilityv1beta1.ClusterQueue, fieldManager string) (*ClusterQueueApplyConfiguration, error) {
	return extractClusterQueue(clusterQueue, fieldManager, "status")
}

func extractClusterQueue(clusterQueue *visibilityv1beta1.ClusterQueue, fieldManager string, subresource string) (*ClusterQueueApplyConfiguration, error) {
	b := &ClusterQueueApplyConfiguration{}
	err := managedfields.ExtractInto(clusterQueue, internal.Parser().Type("io.k8s.sigs.kueue.apis.visibility.v1beta1.ClusterQueue"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
