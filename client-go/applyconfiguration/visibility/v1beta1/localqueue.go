...
// Experimental!
func ExtractLocalQueue(localQueue *visibilityv1beta1.LocalQueue, fieldManager string) (*LocalQueueApplyConfiguration, error) {
...
// Experimental!
func ExtractLocalQueueStatus(localQueue *visibilityv1beta1.LocalQueue, fieldManager string) (*LocalQueueApplyConfiguration, error) {
	return extractLocalQueue(localQueue, fieldManager, "status")
}

func extractLocalQueue(localQueue *visibilityv1beta1.LocalQueue, fieldManager string, subresource string) (*LocalQueueApplyConfiguration, error) {
	b := &LocalQueueApplyConfiguration{}
	err := managedfields.ExtractInto(localQueue, internal.Parser().Type("io.k8s.sigs.kueue.apis.visibility.v1beta1.LocalQueue"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
