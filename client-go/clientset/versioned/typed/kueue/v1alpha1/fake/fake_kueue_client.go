...
func (c *FakeKueueV1alpha1) DynamicResourceAllocationConfigs() v1alpha1.DynamicResourceAllocationConfigInterface {
	return newFakeDynamicResourceAllocationConfigs(c)
}
