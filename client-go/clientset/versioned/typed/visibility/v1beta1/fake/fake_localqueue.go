...
func (c *FakeLocalQueues) Apply(ctx context.Context, localQueue *visibilityv1beta1.LocalQueueApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.LocalQueue, err error) {
	if localQueue == nil {
...
func (c *FakeLocalQueues) GetPendingWorkloadsSummary(ctx context.Context, localQueueName string, options v1.GetOptions) (result *v1beta1.PendingWorkloadsSummary, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewGetSubresourceActionWithOptions(localqueuesResource, c.ns, "pendingworkloads", localQueueName, options), emptyResult)
