...
import (
	...
	v1alpha1 "sigs.k8s.io/kueue/client-go/clientset/versioned/typed/visibility/v1alpha1"
)

type FakeVisibilityV1alpha1 struct {
	*testing.Fake
}

func (c *FakeVisibilityV1alpha1) ClusterQueues() v1alpha1.ClusterQueueInterface {
